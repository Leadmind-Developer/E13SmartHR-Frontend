            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="mb-3">
                  ...
                  <vue3-select :options="StatSelA" v-model="selected" placeholder="Select" />
                </div>
              </div>
            </div>
          </div>
...
export default {
  data() {
    return {
      selected: [],
      selectedOne: [],
      StatSelA: [{label: "Select", value: "Select"}, {label: "Active", value: "Active"}, {label: "Inactive", value: "Inactive"}],
      EditStatSelA: [{label: "Select", value: "Select"}, {label: "Active", value: "Active"}, {label: "Inactive", value: "Inactive"}],
    };
  },
  methods: {
    submitForm() {
