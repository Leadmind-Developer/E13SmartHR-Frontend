    ...
    <div class="content pb-0">
      ...
      <div class="d-flex align-items-sm-center flex-sm-row flex-column gap-2 pb-3">
        <div class="flex-grow-1">
          <h5 class="fw-bold mb-0">Form Validation</h5>
        </div>
      ...
      <div class="row">
        <div class="col-sm-12">
                ...
                <div class="col-sm">
                  <form class="was-validated">
                    ...
                    <div class="custom-radio">
                      <input type="radio" class="form-check-input me-1" id="customControlValidation2"
                        name="radio-stacked" required />
                      <label for="customControlValidation2">Toggle this custom radio</label>
                    </div>
                    <div class="custom-radio mb-3">
                      <input type="radio" class="form-check-input me-1" id="customControlValidation3"
                        name="radio-stacked" required />
          ...
          <div class="card mb-0">
            ...
            <div class="card-body">
              <form ref="form" class="needs-validation" novalidate @submit.prevent="validateFormOne">
                <div class="form-row row">
                  <div class="col-md-4 mb-3">
