                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#edit_language"
                              class="btn btn-sm btn-icon border btn-light"><i class="ti ti-edit"></i></a>
                          </td>
                        </tr>
                        <tr>
                          <td>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="mb-3">
                  ...
                  <vue3-select :options="Module" v-model="selected" placeholder="Employees" />
                </div>
              </div>
              <div class="col-md-12">
                <div class="mb-3">
                  <label class="form-label">Language <span class="text-danger">*</span></label>
                  <vue3-select :options="Language" v-model="selectedOne" placeholder="English" />
                </div>
              </div>
            </div>
          </div>
