      ...
      <div class="card flex-fill">
        <div class="card-header">
          <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2">
            ...
            <div>
              <router-link to="/crm/activity" class="btn btn-light btn-md">View All</router-link>
            </div>
          </div>
        </div>
        <div class="card-body schedule-timeline activity-timeline">
          <div class="d-flex align-items-start">
            ...
            <div class="flex-fill ps-3 pb-4 timeline-flow">
              <p class="fw-medium text-gray-9 mb-1"><router-link to="/crm/activity">Drain responded to your appointment
                  schedule question.</router-link></p>
              <span>09:25 PM</span>
            </div>
          </div>
          <div class="d-flex align-items-start">
            ...
            <div class="flex-fill ps-3 pb-4 timeline-flow">
              <p class="fw-medium text-gray-9 mb-1"><router-link to="/crm/activity">You sent 1 Message to the
                  James.</router-link></p>
              <span>10:25 PM</span>
            </div>
          </div>
          <div class="d-flex align-items-start">
            ...
            <div class="flex-fill ps-3 pb-4 timeline-flow">
              <p class="fw-medium text-gray-9 mb-1"><router-link to="/crm/activity">Denwar responded to your appointment
                  on
                  25 Jan 2025, 08:15 PM</router-link></p>
              <span>09:25 PM</span>
            </div>
          </div>
          <div class="d-flex align-items-start">
            ...
            <div class="flex-fill ps-3 timeline-flow">
              <p class="fw-medium text-gray-9 mb-1"><router-link to="/crm/activity"
                  class="d-flex align-items-center">Meeting
                  With <img src="@/assets/img/users/user-58.jpg" class="avatar avatar-sm rounded-circle mx-2"
                    alt="Img">Abraham</router-link></p>
              <span>09:25 PM</span>
            </div>
          </div>
        </div>
