              ...
              <form @submit.prevent="submitForm">
                <div class="border-bottom mb-3">
                  ...
                  <div class="row align-items-center mb-3">
                    ...
                    <div class="col-xl-3 col-lg-12 col-md-3">
                      <vue3-select :options="NunSel" v-model="selectedOne" placeholder="Select" />
                    </div>
                  </div>
                </div>
...
export default {
  data() {
    return {
      ...
      selected: [],
      selectedOne: [],
      SmallSel: [{label: "Select", value: "Select"}, {label: "Small - 85px", value: "Small - 85px"}, {label: "Large - 250px", value: "Large - 250px"}],
      NunSel: [{label: "Select", value: "Select"}, {label: "Nunito", value: "Nunito"}, {label: "Poppins", value: "Poppins"}],
