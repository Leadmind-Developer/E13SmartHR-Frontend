    ...
    <div class="content pb-0">
      ...
      <div class="d-flex align-items-sm-center flex-sm-row flex-column gap-2 pb-3">
        <div class="flex-grow-1">
          <h5 class="fw-bold mb-0">Links</h5>
        </div>
      ...
      <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                ...
                <a href="javascript:void(0);"><code>.text-*</code> classes</a>, these classes have a
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                <a href="javascript:void(0);">Colored link helpers</a> have been updated to pair with our
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p>
                <a href="javascript:void(0);" class="text-decoration-underline link-underline-primary">Primary
                  underline</a>
              </p>
              <p>
                <a href="javascript:void(0);" class="text-decoration-underline link-underline-secondary">Secondary
                  underline</a>
              </p>
              <p>
                <a href="javascript:void(0);" class="text-decoration-underline link-underline-success">Success
                  underline</a>
              </p>
              <p>
              ...
              <p>
                <a href="javascript:void(0);" class="text-decoration-underline link-underline-warning">Warning
                  underline</a>
              </p>
              <p>
            ...
            <div class="card-body">
              ...
              <p>
                <a class="text-decoration-underline link-offset-2 link-underline link-underline-opacity-0"
                  href="javascript:void(0);">Underline opacity 0</a>
              </p>
              <p>
                <a class="text-decoration-underline link-offset-2 link-underline link-underline-opacity-10"
                  href="javascript:void(0);">Underline opacity 10</a>
              </p>
              <p>
                <a class="text-decoration-underline link-offset-2 link-underline link-underline-opacity-25"
                  href="javascript:void(0);">Underline opacity 25</a>
              </p>
              <p>
                <a class="text-decoration-underline link-offset-2 link-underline link-underline-opacity-50"
                  href="javascript:void(0);">Underline opacity 50</a>
              </p>
              <p>
                <a class="text-decoration-underline link-offset-2 link-underline link-underline-opacity-75"
                  href="javascript:void(0);">Underline opacity 75</a>
              </p>
              <p class="mb-0">
                <a class="text-decoration-underline link-offset-2 link-underline link-underline-opacity-100"
                  href="javascript:void(0);">Underline opacity 100</a>
              </p>
            </div>
            <!-- end card body -->
          </div>
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p>
                <a class="text-decoration-underline link-offset-2" href="javascript:void(0);">Offset 2 link</a>
              </p>
              <p class="mb-0">
                <a class="text-decoration-underline link-offset-3" href="javascript:void(0);">Offset 3 link</a>
              </p>
            </div>
            <!-- end card body -->
          </div>
