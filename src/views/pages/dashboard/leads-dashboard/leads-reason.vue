    ...
    <div class="col-xl-4 d-flex">
      <div class="card flex-fill">
        ...
        <div class="card-body py-0">
          <div>
            <div id="leads_stage">
              <apexchart type="bar" height="345" :options="leadsStageChart.stageLead" :series="leadsStageChart.series">
              </apexchart>
            </div>
          </div>
        </div>
            ...
            <div class="border border-dashed bg-transparent-light rounded p-2 mb-2">
              <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                  <a href="javascript:void(0);" class="avatar rounded-circle bg-white border flex-shrink-0 me-2">
      ...
      <div class="card flex-fill">
        ...
        <div class="card-body">
          <div id="donut-chart-2">
            <apexchart type="donut" height="185" :options="donutChart.dount" :series="donutChart.series">
            </apexchart>
          </div>
          <div>
