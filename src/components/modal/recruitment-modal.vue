                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <vue3-select :options="Tags" v-model="selected" placeholder="Select" />
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3">
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <vue3-select :options="Assignee" v-model="selectedTwo" placeholder="Select" />
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-0">
                                    <label class="form-label">Status</label>
                                    <vue3-select :options="Status" v-model="selectedThree" placeholder="Select" />
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <vue3-select :options="Client" v-model="selectedFour"
                                                placeholder="Select" />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label">Priority</label>
                                                    <vue3-select :options="Priority" v-model="selectedFive"
                                                        placeholder="Select" />
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-icon-end position-relative">
                                                        <a-time-picker class="form-control timepicker"
                                                            placeholder="-- : -- : --" use12-hours format="h:mm a"
                                                            type="text" />
                                                        <span class="input-icon-addon">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <vue3-tags-input class="input-tags form-control" placeholder="Add new"
                                                type="text" data-role="tagsinput" name="Label"
                                                value="Jerald,Andrew,Philip,Davis" :tags="tagsOne" />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <vue3-tags-input class="input-tags form-control" placeholder="Add new"
                                                type="text" data-role="tagsinput" name="Label" value="Hendry,James"
                                                :tags="tagsTwo" />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label class="form-label">Status</label>
                                            <vue3-select :options="Status" v-model="selectedSix" placeholder="Select" />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div>
                                            <label class="form-label">Tags</label>
                                            <vue3-select :options="Tags" v-model="selectedSeven" placeholder="Select" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <vue3-select :options="EmployeeName" v-model="selectedEight" placeholder="Select" />
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label class="form-label">Leave Type</label>
                                    <vue3-select :options="LeaveType" v-model="selectedNine" placeholder="Select" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
...
export default {
    data() {
        return {
            ...
            tagsOne: ["Jerald", "Andrew", "Philip", "Davis"],
            tagsTwo: ["Hendry", "James"],
            tagsThree: ["Dwight"],
        };
    },
    mounted() {
