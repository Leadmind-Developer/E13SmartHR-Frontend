                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <vue3-select :options="DepartM" v-model="selected" placeholder="Select" />
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="mb-3">
                      <label class="form-label">Designation</label>
                      <vue3-select :options="Desig" v-model="selectedOne" placeholder="Select" />
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="mb-3">
              ...
              <div class="modal-body pb-0">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      <label class="form-label">Department</label>
                      <vue3-select :options="EditDepartM" v-model="selectedTwo" placeholder="Finance" />
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="mb-3">
                      <label class="form-label">Designation</label>
                      <vue3-select :options="EditDesig" v-model="selectedThree" placeholder="Finance" />
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="mb-3">
