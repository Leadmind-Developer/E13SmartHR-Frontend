                    ...
                    <div class="card flex-fill">
                        <div class="card-body">
                            <div class="row justify-content-between">
                                ...
                                <div class="col-4">
                                    <div class="text-end">
                                        <div id="tenent-support-chart1">
                                            <apexchart type="bar" width="50" height="115"
                                                :options="tenentSupportChart1.tenentSupport"
                                                :series="tenentSupportChart1.series"></apexchart>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card flex-fill">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="text-end">
                                        <div id="tenent-support-chart2">
                                            <apexchart type="bar" width="50" height="115"
                                                :options="tenentSupportChart2.tenentSupport"
                                                :series="tenentSupportChart2.series"></apexchart>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card flex-fill">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="text-end">
                                        <div id="tenent-support-chart4">
                                            <apexchart type="bar" width="50" height="115"
                                                :options="tenentSupportChart4.tenentSupport"
                                                :series="tenentSupportChart4.series"></apexchart>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card flex-fill">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="text-end">
                                        <div id="tenent-support-chart5">
                                            <apexchart type="bar" width="50" height="115"
                                                :options="tenentSupportChart5.tenentSupport"
                                                :series="tenentSupportChart5.series"></apexchart>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-xl-9 col-md-8">
                                ...
                                <div class="col-xl-9 col-lg-8 col-md-8">
                                    <div
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            <router-link to="/super-admin/tenant-ticket-details"><i
                                                    class="ti ti-eye fs-16 text-gray-5"></i></router-link>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3">
                                        <div class="">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                <span class="avatar avatar-md rounded-circle border p-1 flex-shrink-0">
                    ...
                    <div class="text-center mb-4">
                        <a href="javascript:void(0);" class="btn btn-primary"><i class="ti ti-loader-3 me-1"></i>Load
                            More</a>
                    </div>
                </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <vue3-tags-input class="input-tags form-control" placeholder="Add new" type="text"
                                        data-role="tagsinput" name="Label" value="Vaughan Lewis" :tags="tagsOne" />
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <vue3-select :options="Priority" v-model="selectedOne" placeholder="Select" />
                                </div>
                                <div class="mb-0">
                                    <label class="form-label">Status</label>
                                    <vue3-select :options="Status" v-model="selectedTwo" placeholder="Select" />
                                </div>
                            </div>
                        </div>
                    </div>
...
import { tenentSupportChart1, tenentSupportChart2, tenentSupportChart4, tenentSupportChart5 } from "./data";
export default {
    components: {
        Vue3TagsInput,
    },
