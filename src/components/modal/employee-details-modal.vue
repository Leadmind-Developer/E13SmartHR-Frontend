                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <vue3-select :options="FinanceDeo" v-model="selected" placeholder="Finance" />
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="mb-3">
                      <label class="form-label">Designation</label>
                      <vue3-select :options="OneFinanceDeo" v-model="selectedOne" placeholder="Finance" />
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="mb-3">
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="mb-3">
                  ...
                  <vue3-select :options="MartSel" v-model="selectedTwo" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
              ...
              <div class="row mb-2">
                <div class="col-md-4">
                  <div class="mb-3">
                    ...
                    <vue3-select :options="SaralyBas" v-model="selectedThree" placeholder="Select" />
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="mb-3">
                ...
                <div class="col-md-4">
                  <div class="mb-3">
                    ...
                    <vue3-select :options="PayType" v-model="selectedFour" placeholder="Select" />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="row mb-2">
                <div class="col-md-4">
                  <div class="mb-3">
                    ...
                    <vue3-select :options="FundInt" v-model="selectedFive" placeholder="Select" />
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="mb-3">
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <vue3-select :options="EpsRate" v-model="selectedSix" placeholder="Select" />
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="mb-3">
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="mb-3">
                  ...
                  <vue3-select :options="OneFundInt" v-model="selectedSeven" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-4">
                <div class="mb-3">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  <label class="form-label">Additional rate</label>
                  <vue3-select :options="OneEpsRate" v-model="selectedEight" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
...
const valueFive = ref(new Date());
const valueSix = ref(new Date());
const valueSeven = ref(new Date());
export default {
  data() {
    return {
      showPassword: false,
      ...
      selectedSeven: [],
      selectedEight: [],
      EpsRate: [{ label: "Select", value: "Select" }, { label: "EPS", value: "EPS" }, { label: "ESI", value: "ESI" }, { label: "EPF", value: "EPF" }],
      OneEpsRate: [{ label: "Select", value: "Select" }, { label: "EPS", value: "EPS" }, { label: "ESI", value: "ESI" }, { label: "EPF", value: "EPF" }],
      OneFundInt: [
        { label: "Select", value: "Select" },
        { label: "Employee Contribution", value: "Employee Contribution" },
        { label: "Employer Contribution", value: "Employer Contribution" },
        { label: "Maternity Benefit", value: "Maternity Benefit" },
      ],
      FundInt: [
        { label: "Select", value: "Select" },
        { label: "Employee Contribution", value: "Employee Contribution" },
        { label: "Employer Contribution", value: "Employer Contribution" },
        { label: "Provident Fund Interest", value: "Provident Fund Interest" },
      ],
      PayType: [{ label: "Select", value: "Select" }, { label: "Cash", value: "Cash" }, { label: "Debit Card", value: "Debit Card" }, { label: "Mobile Payment", value: "Mobile Payment" }],
      SaralyBas: [{ label: "Select", value: "Select" }, { label: "Weekly", value: "Weekly" }, { label: "Monthly", value: "Monthly" }, { label: "Annualy", value: "Annualy" }],
      MartSel: [{ label: "Select", value: "Select" }, { label: "Yes", value: "Yes" }, { label: "No", value: "No" }],
      FinanceDeo: [{ label: "Select", value: "Select" }, { label: "All Department", value: "All Department" }, { label: "Finance", value: "Finance" }, { label: "Developer", value: "Developer" }, { label: "Executive", value: "Executive" }],
      OneFinanceDeo: [{ label: "Select", value: "Select" }, { label: "All Department", value: "All Department" }, { label: "Finance", value: "Finance" }, { label: "Developer", value: "Developer" }, { label: "Executive", value: "Executive" }],
    };
  },
  computed: {
    buttonLabel() {
