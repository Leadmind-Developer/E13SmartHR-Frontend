                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="mb-3">
                      ...
                      <vue3-select :options="VillanSel" v-model="selected" placeholder="Seelct" />
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="mb-3">
                          ...
                          <vue3-select :options="PriottyMed" v-model="selectedOne" placeholder="Select" />
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="mb-3">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="mb-3">
                      ...
                      <vue3-select :options="InactDet" v-model="selectedTwo" placeholder="Select" />
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div>
                      <label class="form-label">Tags</label>
                      <vue3-select :options="TagsDet" v-model="selectedThree" placeholder="Select" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="modal-body">
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="mb-3">
                      <label class="form-label">Client</label>
                      <vue3-select :options="AnthonyLw" v-model="selectedFour" placeholder="Select" />
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="mb-3">
                          <label class="form-label">Priority</label>
                          <vue3-select :options="HighMed" v-model="selectedFive" placeholder="High" />
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="mb-3">
              ...
              <div class="modal-body">
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="mb-3">
                      <label class="form-label">Status</label>
                      <vue3-select :options="StaDetail" v-model="selectedSix" placeholder="Active" />
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div>
                      <label class="form-label">Tags</label>
                      <vue3-select :options="HighTagMed" v-model="selectedSeven" placeholder="High" />
                    </div>
                  </div>
                </div>
              </div>
