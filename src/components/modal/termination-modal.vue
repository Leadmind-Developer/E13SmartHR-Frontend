  ...
  data() {
    return {
      ...
      Terminated: [
        ...
        { label: "Doglas Martini", value: "Doglas Martini" }
      ],
      Termination: [
        { label: "Select", value: "Select" },
        { label: "Retirement", value: "Retirement" },
        { label: "Insubordination", value: "Insubordination" },
        { label: "Lack of Skills", value: "Lack of Skills" }
      ],
      valueOne,
      valueTwo,
    };
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="mb-3">
                  ...
                  <vue3-select :options="Terminated" v-model="selected" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-12">
                <div class="mb-3">
                  <label class="form-label">Termination Type</label>
                  <vue3-select :options="Termination" v-model="selectedOne" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-12">
                <div class="mb-3">
          ...
          <div class="modal-body pb-0">
            <div class="row">
              <div class="col-md-12">
                <div class="mb-3">
                  <label class="form-label">Terminated Employee </label>
                  <vue3-select :options="Terminated" v-model="selectedTwo" placeholder="Anthony Lewis" />
                </div>
              </div>
              <div class="col-md-12">
                <div class="mb-3">
                  <label class="form-label">Termination Type</label>
                  <vue3-select :options="Termination" v-model="selectedThree" placeholder="Retirement" />
                </div>
              </div>
              <div class="col-md-12">
                <div class="mb-3">
