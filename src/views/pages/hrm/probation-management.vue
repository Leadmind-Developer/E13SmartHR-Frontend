<template>
                        ...
                        <a-table class="table datatable thead-light" :columns="columns" :data-source="paginatedData"
                            ...
                            <template #bodyCell="{ column, record }">
                                ...
                                <template v-if="column.key === 'Reviewer'">
                                    <div class="d-flex align-items-center file-name-icon">
                                        <a href="javascript:void(0);" class="avatar avatar-md border avatar-rounded">
                                            <img :src=getImageUrlOne(record.ReviewerImage) class="img-fluid" alt="img">
                                        </a>
                                        <div class="ms-2">
                                            <a class="fw-medium fs-14">{{ record.Reviewer }}</a>
                                        </div>
                                    </div>
                                </template>
                                <template v-if="column.key === 'Status'">
                                    <span class="d-inline-flex align-items-center badge-xs badge" :class="{
                                        'badge-soft-info': record.Status === 'Pending',
                                        'badge-soft-success': record.Status === 'Completed',
                                        'badge-soft-warning': record.Status === 'In Review',
                                        'badge-soft-danger': record.Status === 'Failed',
                                        'badge-soft-purple': record.Status === 'Extended',
                                    }">
                                ...
                                <template v-if="column.key === 'action'">
                                    <div class="action-icon d-inline-flex gap-2">
                                        ...
                                        <template v-if="record.EmpID === 'Emp-002' || record.EmpID === 'Emp-006'">
                                            <a href="javascript:void(0);">
                                                <i class="ti ti-refresh"></i>
                                            </a>
                                        </template>
                                        <template v-if="record.EmpID === 'Emp-003' || record.EmpID === 'Emp-007'">
                                            <a href="javascript:void(0);" data-bs-toggle="modal"
                                                data-bs-target="#edit_modal">
                                                <i class="ti ti-edit"></i>
                                            </a>
                                        </template>
                                        <template v-if="record.EmpID === 'Emp-004' || record.EmpID === 'Emp-009'">
                                            <a href="javascript:void(0);"><i class="ti ti-ban"></i></a>
                                        </template>
                                        <template v-if="record.EmpID === 'Emp-008'">
    ...
    <!-- /Page Wrapper -->
    <probation-management-modal></probation-management-modal>
</template>
<script>
...
const columns = [
    ...
    },
    {
        ...
        sorter: {
            compare: (a, b) => {
                a = a.ProbationEndDate.toLowerCase();
                b = b.ProbationEndDate.toLowerCase();
                return a > b ? -1 : b > a ? 1 : 0;
            },
        },
    },
    {
        ...
        sorter: {
            compare: (a, b) => {
                a = a.Reviewer.toLowerCase();
                b = b.Reviewer.toLowerCase();
                return a > b ? -1 : b > a ? 1 : 0;
            },
        },
    },
...
const data = [
    {
        ...
        "ProbationEndDate": "12 Sep 2025",
        "Reviewer": "William Parsons",
        "ReviewerImage": "user-01.jpg",
        "Status": "Pending",
    },
    {
        "key": "2",
        ...
        "ProbationEndDate": "24 Jul 2025",
        "Reviewer": "Lucille Tomberlin",
        "ReviewerImage": "user-02.jpg",
        "Status": "Completed",
    },
    {
        "key": "3",
        ...
        "ProbationEndDate": "08 Aug 2025",
        "Reviewer": "Frederick Johnson",
        "ReviewerImage": "user-03.jpg",
        "Status": "In Review",
    },
    {
        "key": "4",
        ...
        "ProbationEndDate": "27 Jul 2025",
        "Reviewer": "Sarah Henry",
        "ReviewerImage": "user-04.jpg",
        "Status": "Failed",
    },
    {
        "key": "5",
        ...
        "ProbationEndDate": "14 Jun 2025",
        "Reviewer": "Thomas Miller",
        "ReviewerImage": "user-05.jpg",
        "Status": "Extended",
    },
    {
        "key": "6",
        ...
        "ProbationEndDate": "18 Jun 2025",
        "Reviewer": "Melissa Shelton",
        "ReviewerImage": "user-06.jpg",
        "Status": "Completed",
    },
    {
        "key": "7",
        ...
        "ProbationEndDate": "08 Jun 2025",
        "Reviewer": "James Rodriguez",
        "ReviewerImage": "user-07.jpg",
        "Status": "In Review",
    },
    {
        "key": "8",
        ...
        "ProbationEndDate": "18 Apr 2025",
        "Reviewer": "Regina Chavez",
        "ReviewerImage": "user-08.jpg",
        "Status": "Completed",
    },
    {
        "key": "9",
        ...
        "ProbationEndDate": "03 Apr 2025",
        "Reviewer": "Joshua Dillon",
        "ReviewerImage": "user-09.jpg",
        "Status": "Failed",
    },
    {
        "key": "10",
        ...
        "ProbationEndDate": "24 Apr 2025",
        "Reviewer": "Diana Riddle",
        "ReviewerImage": "user-10.jpg",
        "Status": "Pending",
    }
];
const rowSelection = {
        ...
        filteredPages() {
            ...
            return this.data.filter((record) => {
                return (
                    ...
                    record.ProbationEndDate.toLowerCase().includes(query) ||
