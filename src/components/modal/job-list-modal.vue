...
export default {
  data() {
    return {
      ...
      Qualification: [
        { label: "Select", value: "Select" },
        { label: "Bachelore Degree", value: "Bachelore Degree" },
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="mb-3">
                        ...
                        <vue3-select :options="Jobcategory" v-model="selected" placeholder="Select" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label class="form-label">Job Type <span class="text-danger"> *</span></label>
                        <vue3-select :options="Jobtype" v-model="selectedOne" placeholder="Select" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label class="form-label">Job Level <span class="text-danger"> *</span></label>
                        <vue3-select :options="Joblevel" v-model="selectedTwo" placeholder="Select" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label class="form-label">Experience <span class="text-danger"> *</span></label>
                        <vue3-select :options="Experience" v-model="selectedThree" placeholder="Select" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label class="form-label">Qualification <span class="text-danger"> *</span></label>
                        <vue3-select :options="Qualification" v-model="selectedFour" placeholder="Select" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label class="form-label">Gender <span class="text-danger"> *</span></label>
                        <vue3-select :options="Gender" v-model="selectedFive" placeholder="Select" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label class="form-label">Min. Sallary <span class="text-danger"> *</span></label>
                        <vue3-select :options="Minsalary" v-model="selectedSix" placeholder="Select" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label class="form-label">Max. Sallary <span class="text-danger"> *</span></label>
                        <vue3-select :options="Maxsalary" v-model="selectedSeven" placeholder="Select" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="mb-3">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="mb-3">
                        ...
                        <vue3-select :options="City" v-model="selectedEight" placeholder="Select" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label class="form-label">State <span class="text-danger"> *</span></label>
                        <vue3-select :options="State" v-model="selectedNine" placeholder="Select" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label class="form-label">Country <span class="text-danger"> *</span></label>
                        <vue3-select :options="Country" v-model="selectedTen" placeholder="Select" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="mb-3">
                ...
                <div class="tab-pane fade show active" id="basic-infos" role="tabpanel" aria-labelledby="info-tab"
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label class="form-label">Job Category <span class="text-danger"> *</span></label>
                        <vue3-select :options="Jobcategory" v-model="selectedEleven" placeholder="IOS" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label class="form-label">Job Type <span class="text-danger"> *</span></label>
                        <vue3-select :options="Jobtype" v-model="selectedTwelve" placeholder="Select" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label class="form-label">Job Level <span class="text-danger"> *</span></label>
                        <vue3-select :options="Joblevel" v-model="selectedThirteen" placeholder="Team Lead" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label class="form-label">Experience <span class="text-danger"> *</span></label>
                        <vue3-select :options="Experience" v-model="selected1" placeholder="Entry Level" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label class="form-label">Qualification <span class="text-danger"> *</span></label>
                        <vue3-select :options="Qualification" v-model="selected2" placeholder="Bachelore Degree" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label class="form-label">Gender <span class="text-danger"> *</span></label>
                        <vue3-select :options="Gender" v-model="selected3" placeholder="Female" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label class="form-label">Min. Sallary <span class="text-danger"> *</span></label>
                        <vue3-select :options="Minsalary" v-model="selected4" placeholder="10k - 15k" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label class="form-label">Max. Sallary <span class="text-danger"> *</span></label>
                        <vue3-select :options="Maxsalary" v-model="selected5" placeholder="40k - 50k" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="mb-3">
                ...
                <div class="tab-pane fade" id="addresss" role="tabpanel" aria-labelledby="address-tab" tabindex="0">
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label class="form-label">City <span class="text-danger"> *</span></label>
                        <vue3-select :options="City" v-model="selected6" placeholder="Bristol" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label class="form-label">State <span class="text-danger"> *</span></label>
                        <vue3-select :options="State" v-model="selected7" placeholder="Lancaster" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label class="form-label">Country <span class="text-danger"> *</span></label>
                        <vue3-select :options="Country" v-model="selected8" placeholder="UK" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="mb-3">
