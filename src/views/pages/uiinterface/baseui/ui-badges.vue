          ...
          <div class="row">
            <div class="col-xl-12">
              <div class="card">
                ...
                <div class="card-body">
                  <span class="badge bg-secondary"><span class="badge-label">Secondary</span><vue-feather class="ms-1"
                      type="plus" style="height: 12px; width: 12px"></vue-feather></span>
                  <span class="badge bg-success ms-1"><span class="badge-label">Success</span><vue-feather class="ms-1"
                      type="check" style="height: 12px; width: 12px"></vue-feather></span>
                  <span class="badge bg-info ms-1"><span class="badge-label">Info</span><vue-feather class="ms-1"
                      type="info" style="height: 12px; width: 12px"></vue-feather></span>
                  <span class="badge bg-warning ms-1"><span class="badge-label">Warning</span><vue-feather class="ms-1"
                      type="alert-octagon" style="height: 12px; width: 12px"></vue-feather></span>
                  <span class="badge bg-danger ms-1"><span class="badge-label">Danger</span><vue-feather class="ms-1"
                      type="x" style="height: 12px; width: 12px"></vue-feather></span>
                </div>
              </div>
              <div class="card">
                <div class="card-header">
                ...
                <div class="card-body">
                  <span class="badge bg-outline-secondary"><span class="badge-label">Secondary</span><vue-feather
                      class="ms-1" type="plus" style="height: 12px; width: 12px">
                    </vue-feather></span>
                  <span class="badge bg-outline-success ms-1"><span class="badge-label">Success</span><vue-feather
                      class="ms-1" type="check" style="height: 12px; width: 12px"></vue-feather></span>
                  <span class="badge bg-outline-info ms-1"><span class="badge-label">Info</span><vue-feather
                      class="ms-1" type="info" style="height: 12px; width: 12px"></vue-feather></span>
                  <span class="badge bg-outline-warning ms-1"><span class="badge-label">Warning</span><vue-feather
                      class="ms-1" type="alert-octagon" style="height: 12px; width: 12px"></vue-feather></span>
                  <span class="badge bg-outline-danger ms-1"><span class="badge-label">Danger</span><vue-feather
                      class="ms-1" type="x" style="height: 12px; width: 12px"></vue-feather></span>
                </div>
              </div>
            </div>
          </div>
