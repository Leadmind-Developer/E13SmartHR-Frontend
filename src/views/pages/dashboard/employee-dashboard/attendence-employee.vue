      ...
      <div class="card flex-fill border-primary attendance-bg">
        <div class="card-body">
          ...
          <div class="attendance-circle-progress attendance-progress mx-auto mb-3">
            <CircleProgress :value="65" time="5:45:32" label="Total Hours" />
          </div>
          ...
          <div class="card">
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-xl-3">
                  <div class="mb-4">
                    <p class="d-flex align-items-center mb-1"><i class="ti ti-point-filled text-warning me-1"></i>Break
                      hours</p>
                    <h3>22m 15s</h3>
                  </div>
                </div>
                <div class="col-xl-3">
                  <div class="mb-4">
                    <p class="d-flex align-items-center mb-1"><i class="ti ti-point-filled text-info me-1"></i>Overtime
                    </p>
                    <h3>02h 15m</h3>
                  </div>
                </div>
