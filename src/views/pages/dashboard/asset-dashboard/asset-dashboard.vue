        ...
        <div class="content">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
                ...
                <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
                    <a href="javascript:void(0);" class="btn btn-white me-2 mb-2"> <i class="ti ti-user"></i> Add
                        Assignee</a>
                    <a href="javascript:void(0);" class="btn btn-secondary mb-2 me-2"> <i class="ti ti-calendar"></i>
                        Schedule
                        Maintainance</a>
                ...
                <div class="col-xl-8">
                    ...
                    <div class="card position-relative analysis-card">
                        <div class="card-body">
                            ...
                            <div id="purchase-trend" style="position:relative">
                                <apexchart type="area" height="253" :options="purchaseTrend.purchase"
                                    :series="purchaseTrend.series"></apexchart>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="pb-2 d-flex align-items-center justify-content-between flex-wrap mb-3">
                                ...
                                <a href="javascript:void(0);"><i class="ti ti-refresh fs-20 text-secondary"></i></a>
                            </div>

                            <div id="assets-department">
                                <apexchart type="bar" height="296" :options="assetsDepartment.assets"
                                    :series="assetsDepartment.series"></apexchart>
                            </div>
                ...
                <div class="col-xl-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h2>1,247</h2>
                            <div id="total-assets">
                                <apexchart type="bar" height="116" width="100%" :options="totalAssets.total"
                                    :series="totalAssets.series"></apexchart>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="assets-assigned">
                                <apexchart type="bar" height="116" width="100%" :options="assetsAssigned.assigned"
                                    :series="assetsAssigned.series"></apexchart>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="assets-available">
                                <apexchart type="bar" height="116" width="100%" :options="assetsAvailable.available"
                                    :series="assetsAvailable.series"></apexchart>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="asset-value">
                                <apexchart type="bar" height="65" :options="assetValue.asset"
                                    :series="assetValue.series"></apexchart>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div id="depreciated-value">
                                    <apexchart width="100" height="60" type="bar"
                                        :options="depreciatedValue.depreciated" :series="depreciatedValue.series">
                                    </apexchart>
                                </div>
                            </div>
                            ...
                            <div class="row d-flex align-items-center justify-content-center ">
                                <div class="col-md-6">
                                    <div id="asset-categories-chart">
                                        <apexchart type="pie" height="290"
                                            :options="assetCategoriesChart.assetCategories"
                                            :series="assetCategoriesChart.series"></apexchart>
                                    </div>
                                </div>
            ...
            <div class="card job-opening-table">
                <div class="card-body">
                    ...
                    <div class="pb-2 d-flex align-items-center justify-content-between flex-wrap mb-3">
                        ...
                        <a href="javascript:void(0);"
                            class="btn btn-primary-gradient btn-sm d-inline-flex align-items-center">
                            View All
                        </a>
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-icon d-inline-flex">
                                        <a href="javascript:void(0);" class="me-1"><i class="ti ti-edit"></i></a>
