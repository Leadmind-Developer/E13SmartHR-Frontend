                    ...
                    <div class="border rounded p-3 mb-3">
                      <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
                        <div class="d-flex align-items-center">
                          ...
                          <div>
                            <p class="fw-medium"><span class="text-dark">Darlee Robertson </span> logged a call on 23
                              Jul 2023, 10:00 pm</p>
                          </div>
                        </div>
                        <div class="d-flex align-items-center">
                          <div class="dropdown me-2">
                            <a href="#" class="dropdown-toggle btn btn-sm bg-danger-transparent border-0 h-none h-none"
                      ...
                      <div>
                        <p>A project review evaluates the success of an initiative and identifies areas for
                          ...
                          to determine whether it's on the right track. Or, it can determine the success of a completed
                          project
                        </p>
                      </div>
                    </div>
                    <div class="border rounded p-3 mb-3">
                      <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
                        <div class="d-flex align-items-center">
                          ...
                          <div>
                            <p class="fw-medium"><span class="text-dark">Sharon Roy </span>  logged a call on 28 Jul
                              2023, 09:00 pm</p>
                          </div>
                        </div>
                        <div class="d-flex align-items-center">
                          <div class="dropdown me-2">
                            <a href="#" class="dropdown-toggle btn btn-sm bg-transparent-purple border-0 h-none h-none"
                    ...
                    <div class="border rounded p-3">
                      <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
                        <div class="d-flex align-items-center">
                          ...
                          <div>
                            <p class="fw-medium"><span class="text-dark">Vaughan Lewis </span> logged a call on 30 Jul
                              2023, 08:00 pm</p>
                          </div>
                        </div>
                        <div class="d-flex align-items-center">
