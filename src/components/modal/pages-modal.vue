...
export default {
  ...
  data() {
    return {
      ...
      Visibility: [{ label: "Select", value: "Select" }, { label: "Show", value: "Show" }, { label: "Hide", value: "Hide" }],
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <vue3-select :options="Visibility" v-model="selected" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-12">
                <div class="mb-3">
          ...
          <div class="modal-body pb-0">
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  <label class="form-label">Visibility</label>
                  <vue3-select :options="Visibility" v-model="selectedTwo" placeholder="Show" />
                </div>
              </div>
              <div class="col-md-12">
                <div class="mb-3">
