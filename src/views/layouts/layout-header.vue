      ...
      <div class="header-user">
        <div class="nav user-menu nav-list">
          ...
          <div class="me-auto d-flex align-items-center" id="header-search">
            <a id="toggle_btn" href="javascript:void(0);" @click="toggleSidebar" class="btn btn-menubar me-2">
                ...
                <div class="card mb-0 border-0 shadow-none">
                  ...
                  <div class="card-body">
                    ...
                    <router-link to="/applications/todo" class="d-block py-2">
                      <span class="avatar avatar-md bg-transparent-dark me-2"><i
                          class="ti ti-subtask text-gray-9"></i></span>To
                      Do
                    </router-link>
                    ...
                    <router-link to="/applications/file-manager" class="d-block py-2">
                      <span class="avatar avatar-md bg-transparent-dark me-2"><i
                          class="ti ti-folder text-gray-9"></i></span>File
                      Manager
                    </router-link>
              ...
              <div class="dropdown-menu shadow-none">
                <div class="card mb-0">
                  ...
                  <div class="card-footer">
                    <router-link class="dropdown-item d-inline-flex align-items-center p-0 py-2" to="/login">
