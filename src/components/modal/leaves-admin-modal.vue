...
export default {
  data() {
    return {
      ...
      selectedTwo: [],
      selectedThree: [],
      Employeename: [{ label: "Select", value: "Select" }, { label: "Anthony Lewis", value: "Anthony Lewis" }, { label: "Brian Villalobos", value: "Brian Villalobos" }, { label: "Harvey Smith", value: "Harvey Smith" }],
      Leavetype: [{ label: "Select", value: "Select" }, { label: "Medical Leave", value: "Medical Leave" }, { label: "Casual Leave", value: "Casual Leave" }, { label: "Annual Leave", value: "Annual Leave" }],
      valueOne,
      valueTwo,
    };
  },
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="mb-3">
                  ...
                  <vue3-select :options="Employeename" v-model="selected" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-12">
                <div class="mb-3">
                  <label class="form-label">Leave Type</label>
                  <vue3-select :options="Leavetype" v-model="selectedOne" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
          ...
          <div class="modal-body pb-0">
            <div class="row">
              <div class="col-md-12">
                <div class="mb-3">
                  <label class="form-label">Employee Name</label>
                  <vue3-select :options="Employeename" v-model="selectedTwo" placeholder="Anthony Lewis" />
                </div>
              </div>
              <div class="col-md-12">
                <div class="mb-3">
                  <label class="form-label">Leave Type</label>
                  <vue3-select :options="Leavetype" v-model="selectedThree" placeholder="Medical Leave" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
