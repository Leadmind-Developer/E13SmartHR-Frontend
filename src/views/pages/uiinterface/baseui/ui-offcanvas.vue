        ...
        <div class="col-xl-6">
          <div class="card">
            <div class="card-body card-buttons">
              ...
              <div class="button-list">
                <a class="btn btn-primary mt-1 me-2" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button"
          ...
          <div class="card">
            <div class="card-body card-buttons">
              ...
              <div class="button-list">
                <button class="btn btn-primary mt-2 me-2" type="button" data-bs-toggle="offcanvas"
