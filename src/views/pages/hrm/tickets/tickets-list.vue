          ...
          <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3">
              ...
              <div class="d-flex align-items-center">
                ...
                <div>
                  <vue3-select :options="PublSel" v-model="selected" placeholder="Mark as Private" />
                </div>
              </div>
            </div>
            <div class="card-body">
          ...
          <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3">
              ...
              <div class="d-flex align-items-center">
                ...
                <div>
                  <vue3-select :options="PublSelOne" v-model="selectedTwo" placeholder="Mark as Public" />
                </div>
              </div>
            </div>
            <div class="card-body">
          ...
          <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3">
              ...
              <div class="d-flex align-items-center">
                ...
                <div>
                  <vue3-select :options="PublSelTwo" v-model="selectedThree" placeholder="Mark as Private" />
                </div>
              </div>
            </div>
            <div class="card-body">
            ...
            <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3">
              ...
              <div class="d-flex align-items-center">
                <span class="badge badge-success d-inline-flex align-items-center me-3"><i
                    class="ti ti-circle-filled fs-5 me-1"></i>Low</span>
                <div>
                  <vue3-select :options="PublSelThree" v-model="selectedFour" placeholder="Mark as Private" />
                </div>
              </div>
            </div>
            <div class="card-body">
...
export default {
  data() {
    return {
      ...
      selectedThree: [],
      selectedFour: [],
      PublSel: [{ label: "Mark as Private", value: "Mark as Private" }, { label: "Mark as Public", value: "Mark as Public" }],
      PublSelOne: [{ label: "Mark as Private", value: "Mark as Private" }, { label: "Mark as Public", value: "Mark as Public" }],
      PublSelTwo: [{ label: "Mark as Private", value: "Mark as Private" }, { label: "Mark as Public", value: "Mark as Public" }],
      PublSelThree: [{ label: "Mark as Private", value: "Mark as Private" }, { label: "Mark as Public", value: "Mark as Public" }],
    };
  },
  methods: {
    toggleHeader() {
