      ...
      <div class="card flex-fill">
        <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-2">
          ...
          <div class="d-flex align-items-center">
            <div>
              <router-link to="/crm/deals-list" class="btn btn-md btn-light">View All</router-link>
            </div>
          </div>
        </div>
          ...
          <div class="table-responsive">
            <table class="table table-nowrap dashboard-table mb-0">
              ...
              <tbody>
                <tr>
                  <td>
                    <h6 class="fw-medium"><router-link to="/crm/deals-details">Collins</router-link></h6>
                  </td>
                ...
                <tr>
                  <td>
                    <h6 class="fw-medium"><router-link to="/crm/deals-details">Konopelski</router-link></h6>
                  </td>
                  <td>Proposal Made</td>
                  <td>
                    $3,15,000
                ...
                <tr>
                  <td>
                    <h6 class="fw-medium"><router-link to="/crm/deals-details">Adams</router-link></h6>
                  </td>
                  <td>Contact Made</td>
                  <td>
                    $8,40,000
                ...
                <tr>
                  <td>
                    <h6 class="fw-medium"><router-link to="/crm/deals-details">Schumm</router-link></h6>
                  </td>
                  <td>Quality To Buy</td>
                  <td>
                    $6,10,000
                ...
                <tr>
                  <td>
                    <h6 class="fw-medium"><router-link to="/crm/deals-details">Wisozk</router-link></h6>
                  </td>
                  <td>Presentation</td>
                  <td>
                    $4,70,000
      ...
      <div class="card flex-fill">
        <div class="card-header">
          <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2">
            ...
            <div>
              <router-link to="/crm/activity" class="btn btn-md btn-light">View All</router-link>
            </div>
          </div>
        </div>
          ...
          <div class="d-flex align-items-start">
            ...
            <div class="flex-fill ps-3 pb-4 timeline-flow">
              <p class="fw-medium text-gray-9 mb-1"><router-link to="/crm/activity">Denwar responded to your appointment
                  on 25
                  Jan 2025, 08:15 PM</router-link></p>
              <span>09:25 PM</span>
            </div>
          </div>
          <div class="d-flex align-items-start">
