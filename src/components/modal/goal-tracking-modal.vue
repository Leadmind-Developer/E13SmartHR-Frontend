...
export default {
  data() {
    return {
      ...
      selectedTwo: [],
      selectedThree: [],
      Goaltype: [{ label: "Select", value: "Select" }, { label: "Development Goals", value: "Development Goals" }, { label: "Project Goals", value: "Project Goals" }],
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="mb-3">
                  ...
                  <vue3-select :options="Goaltype" v-model="selected" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
          ...
          <div class="modal-body pb-0">
            <div class="row">
              <div class="col-md-12">
                <div class="mb-3">
                  <label class="form-label">Goal Type</label>
                  <vue3-select :options="Goaltype" v-model="selectedTwo" placeholder="Development Goals" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
