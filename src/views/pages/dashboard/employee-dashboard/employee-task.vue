  ...
  <div class="row">
    ...
    <div class="col-xxl-6 d-flex">
      <div class="card flex-fill">
        ...
        <div class="card-body">
          <div class="list-group list-group-flush d-flex justify-content-between flex-column h-100">
            <div class="list-group-item border rounded p-2">
              <div class="row align-items-center row-gap-3">
                <div class="col-md-8">
                  <div class="todo-inbox-check d-flex align-items-center" :class="{ 'todo-strike-content': isClicked }"
                    @click="toggleClicked">
