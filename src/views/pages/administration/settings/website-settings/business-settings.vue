                    ...
                    <div class="col-md-6">
                      <div class="d-flex align-items-center flex-wrap row-gap-3 bg-light w-100 rounded p-3 mb-4">
                        <div
                          ...
                          <img src="@/assets/img/logo-white.png" class="img-fluid text-white" alt="logo" />
                        </div>
                        <div class="profile-upload">
                          <div class="mb-2">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="row align-items-center mb-3">
                        ...
                        <div class="col-md-8">
                          <div>
                            <vue3-select :options="Countries" v-model="selected" placeholder="Select" />
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="row align-items-center mb-3">
                        ...
                        <div class="col-md-8">
                          <div>
                            <vue3-select :options="States" v-model="selectedOne" placeholder="Select" />
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="row align-items-center mb-3">
                        ...
                        <div class="col-md-8">
                          <vue3-select :options="Cities" v-model="selectedTwo" placeholder="Select" />
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
...
export default {
  data() {
    return {
      ...
      text1: "Business Settings",
    };
  },
  methods: {
    submitForm() {
      this.$router.push("/website-settings/business-settings");
    },
    toggleHeader() {
