            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-6 mt-4">
                  ...
                  <p class="text-muted">
                    When you have multiple toasts, we default to vertiaclly stacking them
        ...
        <div class="col-lg-6">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div
                class="toast show align-items-center text-white bg-primary border-0 mb-3"
                role="alert"
                aria-live="assertive"
                aria-atomic="true"
              >
          ...
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                ...
                one toast at a time, put the positioning styles right on the
                <code>.toast</code>.
              </p>
              <form>
                <div class="mb-3">
