                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="row align-items-center mb-3">
                        ...
                        <div class="col-md-8">
                          <div>
                            <vue3-select :options="IndUk" v-model="selected" placeholder="Select" />
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="row align-items-center mb-3">
                        ...
                        <div class="col-md-8">
                          <div>
                            <vue3-select :options="UkSek" v-model="selectedOne" placeholder="Select" />
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="row align-items-center mb-3">
                        ...
                        <div class="col-md-8">
                          <vue3-select :options="Cityselc" v-model="selectedTwo" placeholder="Select" />
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
...
export default {
  data() {
    return {
      ...
      selectedOne: [],
      selectedTwo: [],
      UkSek: [{ label: "Select", value: "Select" }, { label: "California", value: "California" }, { label: "New York", value: "New York" }, { label: "Texas", value: "Texas" }, { label: "Florida", value: "Florida" }],
      IndUk: [{ label: "Select", value: "Select" }, { label: "France", value: "France" }, { label: "Germany", value: "Germany" }, { label: "Canada", value: "Canada" }, { label: "USA", value: "USA" }],
      Cityselc: [{ label: "Select", value: "Select" }, { label: "Los Angeles", value: "Los Angeles" }, { label: "San Diego", value: "San Diego" }, { label: "Fresno", value: "Fresno" }, { label: "San Francisco", value: "San Francisco" }],
      title: "Settings",
