        ...
        <div class="card-body">
          <div class="bg-light p-3 br-5 mb-4">
            ...
            <div class="d-flex align-items-center flex-wrap">
              <p class="fs-13 mb-1 ms-2"><i class="ti ti-calendar-event ms-2"></i>Thu, 15 Feb 2025</p>
              <p class="fs-13 mb-1"><i class="ti ti-clock-hour-11 ms-2"></i>01:00 PM - 02:20 PM</p>
            </div>
            <div class="d-flex align-items-center justify-content-between border-top mt-2 pt-3">
              ...
              <a href="javascript:void(0);" class="btn btn-white">Join Meeting</a>
            </div>
          </div>
          <div class="bg-light p-3 br-5 mb-0">
            ...
            <div class="d-flex align-items-center flex-wrap">
              <p class="fs-13 mb-1 ms-2"><i class="ti ti-calendar-event ms-2"></i>Thu, 15 Feb 2025</p>
              <p class="fs-13 mb-1"><i class="ti ti-clock-hour-11 ms-2"></i>02:00 PM - 04:20 PM</p>
            </div>
            <div class="d-flex align-items-center justify-content-between border-top mt-2 pt-3">
              <div class="avatar-list-stacked avatar-group-sm">
                <span class="avatar avatar-rounded">
    ...
    <div class="col-xxl-4 col-xl-6 d-flex">
      <div class="card flex-fill">
        ...
        <div class="card-body pb-1">
          ...
          <div class="p-2 border border-dashed rounded mb-3 birthday-card active">
            <div class="d-flex align-items-center justify-content-between">
              ...
              <a href="javascript:void(0);" class="btn btn-sm btn-white"><i class="ti ti-cake me-1"></i>Send</a>
            </div>
          </div>
          <h6 class="mb-2">Tomorrow</h6>
          <div class="p-2 border border-dashed rounded mb-3 birthday-card">
            <div class="d-flex align-items-center justify-content-between">
              <div class="d-flex align-items-center">
                <a href="javascript:void(0);" class="avatar">
