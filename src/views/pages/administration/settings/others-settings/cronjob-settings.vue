            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="mb-3">
                  ...
                  <vue3-select :options="SchedCron" v-model="selected" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-12">
                <div class="row">
          ...
          <div class="modal-body pb-0">
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="mb-3">
                  <label class="form-label">Schedule</label>
                  <vue3-select :options="EditSchedCron" v-model="selectedOne" placeholder="5 Minutes" />
                </div>
              </div>
              <div class="col-md-12">
                <div class="row">
...
export default {
  data() {
    return {
      ...
      text1: "Cronjob Settings",
      selected: [],
      selectedOne: [],
      SchedCron: [{ label: "Select", value: "Select" }, { label: "5 Minutes", value: "5 Minutes" }, { label: "3 Minutes", value: "3 Minutes" }],
      EditSchedCron: [{ label: "Select", value: "Select" }, { label: "5 Minutes", value: "5 Minutes" }, { label: "3 Minutes", value: "3 Minutes" }],
    };
  },
  methods: {
    toggleHeader() {
