            ...
            <div class="row">
              <div class="col-md-12">
                <div class="mb-3">
                  ...
                  <vue3-select :options="Leavetype" v-model="selected" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
          ...
          <div class="modal-body pb-0">
            <div class="row">
              <div class="col-md-12">
                <div class="mb-3">
                  <label class="form-label">Leave Type</label>
                  <vue3-select :options="Leavetype" v-model="selectedOne" placeholder="Medical Leave" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
      ...
      <div class="modal-content">
        <div class="modal-body text-center">
          ...
          <div class="d-flex justify-content-center">
            ...
            <router-link to="/leave/leaves-employee" class="btn btn-danger">Yes, Delete</router-link>
          </div>
        </div>
      </div>
    </div>
