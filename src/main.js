...
import layoutLoader from '@/views/layouts/layout-loader.vue';
import Layout_Header_RTL from '@/views/layouts/layout-header-rtl.vue';
...
import topEmployees from '@/views/pages/dashboard/hr-dashboard/top-employees.vue';
import TraningChart from '@/views/pages/dashboard/hr-dashboard/traning-chart.vue';
import RecruitmentOverview from '@/views/pages/dashboard/recruitment-dashboard/recruitment-overview.vue';
import RecruitmentAverage from '@/views/pages/dashboard/recruitment-dashboard/recruitment-average.vue';
import FinanceHR from '@/views/pages/dashboard/finance-dashboard/finance-hr.vue';
import HelpTicket from '@/views/pages/dashboard/help-desk-dashboard/help-ticket.vue';
import HelpAgent from '@/views/pages/dashboard/help-desk-dashboard/help-agent.vue';
...
import agentsModal from '@/components/modal/agents-modal.vue';
import slaPoliciesModal from '@/components/modal/sla-policies-modal.vue';
import escalationRulesModal from '@/components/modal/escalation-rules-modal.vue';
import probationManagementModal from '@/components/modal/probation-management-modal.vue';
import noticePeriodTrackerModal from '@/components/modal/notice-period-tracker-modal.vue';
import recruitmentModal from '@/components/modal/recruitment-modal.vue';
import assetDashboardModal from '@/components/modal/asset-dashboard-modal.vue';
import tenantTicketDetailsModal from '@/components/modal/tenant-ticket-details-modal.vue';
import campusHiringModal from '@/components/modal/campus-hiring-modal.vue';
import certificationTrackingModal from '@/components/modal/certification-tracking-modal.vue';
import shiftSwapRequestsModal from '@/components/modal/shift-swap-requests-modal.vue';
import workFromHomeModal from '@/components/modal/work-from-home-modal.vue';
...
app.component('layout-loader', layoutLoader)
app.component('layout-header-rtl', Layout_Header_RTL)
...
app.component('top-employees', topEmployees)
app.component('traning-chart', TraningChart)
app.component('recruitment-overview', RecruitmentOverview)
app.component('recruitment-average', RecruitmentAverage)
app.component('finance-hr', FinanceHR)
app.component('help-ticket', HelpTicket)
app.component('help-agent', HelpAgent)
...
app.component('agents-modal', agentsModal)
app.component('sla-policies-modal', slaPoliciesModal)
app.component('escalation-rules-modal', escalationRulesModal)
app.component('probation-management-modal', probationManagementModal)
app.component('notice-period-tracker-modal', noticePeriodTrackerModal)
app.component('recruitment-modal', recruitmentModal)
app.component('asset-dashboard-modal', assetDashboardModal)
app.component('tenant-ticket-details-modal', tenantTicketDetailsModal)
app.component('campus-hiring-modal', campusHiringModal)
app.component('certification-tracking-modal', certificationTrackingModal)
app.component('shift-swap-requests-modal', shiftSwapRequestsModal)
app.component('work-from-home-modal', workFromHomeModal)
