            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="mb-3">
                  ...
                  <vue3-select :options="CurrenSta" v-model="selected" placeholder="Select" />
                </div>
              </div>
            </div>
          </div>
...
export default {
  data() {
    return {
      selected: [],
      selectedOne: "Active",
      CurrenSta: [{label: "Select", value: "Select"}, {label: "Active", value: "Active"}, {label: "Inactive", value: "Inactive"}],
      EditCurrenSta: [{label: "Select", value: "Select"}, {label: "Active", value: "Active"}, {label: "Inactive", value: "Inactive"}],
    };
  },
  methods: {
    submitForm() {
