import { ticketStatus } from '../../dashboard/help-desk-dashboard/data';
...
<template>
    ...
    <div class="page-wrapper">
        <div class="content">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
                <div class="mb-2">
                    <h6 class="fw-medium d-flex align-items-center"><router-link
                            to="/super-admin/tenant-support-tickets"><i class="ti ti-arrow-left me-2"></i>Ticket
                            Details</router-link></h6>
                </div>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu  dropdown-menu-end p-2">
                                        ...
                                        <li>
                                            <a href="javascript:void(0);" class="dropdown-item rounded-1">Mark as Public
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div>
                                <div class="d-flex justify-content-between flex-wrap border-bottom mb-3">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap row-gap-2">
                                                <p class="d-flex align-items-center mb-0 me-2">
                                                    <img src="@/assets/img/profiles/avatar-06.jpg"
                                                        class="avatar avatar-xs rounded-circle me-2" alt="img">Assigned
                                                    to <span class="text-dark ms-1">Edgar Hansel</span>
                                                </p>
                                    ...
                                    <div class="mb-3">
                                        <a href="javascript:void(0);" class="btn btn-dark"><i
                                                class="ti ti-arrow-forward-up me-1"></i>Post
                                            Reply</a>
                                    </div>
                                </div>
                                <div class="border-bottom mb-3 pb-3">
                                    <div>
                                        <p class="mb-0">For the past two days, we have been unable to log in to our
                                            ...
                                            either refreshes without any message or shows “Invalid Credentials.” We have
                                            confirmed that the credentials are correct, but the issue continues.</p>
                                        <p>We also attempted to reset our passwords, but none of us received the
                                            password reset email. We checked our inboxes, spam folders, and promotion
                                            folders no email arrived. This issue is preventing our team from accessing
                                            the dashboard and is affecting our daily operations.</p>
                                    </div>
                                    <div class="mt-4">
                                        ...
                                        <div>
                                            <div class="mb-3">
                                                <p>This issue is preventing access to the dashboard and blocking daily
                                                    operations for our team</p>
                                            </div>
                                            ...
                                            <div class="d-flex align-items-center mt-3">
                                                ...
                                                <p><a href="javascript:void(0);" class="d-flex align-items-center"><i
                                                            class="ti ti-message-circle-share me-1"></i>1 Comment</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="border-bottom mb-3 pb-3">
                                    <div>
                                        ...
                                        <div>
                                            <div class="mb-3">
                                                <p>Please verify if the authentication service is running normally. Also
                                                    check if the user account is locked due to multiple failed attempts.
                                                </p>
                                            </div>
                                            <div class="d-flex align-items-center">
                                                <span class="badge bg-light fw-normal">Screenshot.png<i
                                            ...
                                            <div class="d-flex align-items-center mt-3">
                                                <a href="javascript:void(0);"
                                                    class="d-inline-flex align-items-center text-primary fw-medium me-3"><i
                                                        class="ti ti-arrow-forward-up me-1"></i>Reply</a>
                                                <p><a href="javascript:void(0);" class="d-flex align-items-center"><i
                                                            class="ti ti-message-circle-share me-1"></i>5 Comments</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div>
                                            <div class="mb-3">
                                                <p>Check the email service logs to confirm if password reset emails
                                                    failed or were blocked. Also confirm if SMTP configuration is active
                                                    or not.</p>
                                            </div>
                                            <div class="d-flex align-items-center mt-3">
                                                <a href="javascript:void(0);"
                                                    class="d-inline-flex align-items-center text-primary fw-medium me-3"><i
                                                        class="ti ti-arrow-forward-up me-1"></i>Reply</a>
                                                <p><a href="javascript:void(0);" class="d-flex align-items-center"><i
                                                            class="ti ti-message-circle-share me-1"></i>9 Comments</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card-body p-0">
                            <div class="border-bottom p-3">
                                <div class="mb-3">
                                    ...
                                    <vue3-select :options="Priority" v-model="selected" placeholder="High" />
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Assign To</label>
                                    <vue3-select :options="AssignTo" v-model="selectedOne" placeholder="Edgar Hansel" />
                                </div>
                                <div>
                                    <label class="form-label">Ticket Status</label>
                                    <vue3-select :options="TicketStatus" v-model="selectedTwo" placeholder="Open" />
                                </div>
                            </div>
                            <div class="d-flex align-items-center border-bottom p-3">
                                <span class="avatar avatar-md border p-1 rounded-circle me-2 flex-shrink-0"><img
                                        src="@/assets/img/company/company-01.svg" class="rounded-circle"
                                        alt="Img"></span>
                                <div>
                            ...
                            <div class="d-flex align-items-center border-bottom p-3">
                                <span class="avatar avatar-md me-2 flex-shrink-0"><img
                                        src="@/assets/img/users/user-05.jpg" class="rounded-circle" alt="Img"></span>
                                <div>
    ...
    <!-- /Page Wrapper -->
    <tenant-ticket-details-modal></tenant-ticket-details-modal>
</template>
<script>
export default {
    data() {
        return {
            ...
            AssignTo: [
                { label: 'Edgar Hansel', value: 'edgar_hansel' },
                { label: 'Juan Hermann', value: 'juan_hermann' },
            ],
            TicketStatus: [
