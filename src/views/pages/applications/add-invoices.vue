                ...
                <div class="row">
                  ...
                  <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="mb-3">
                      ...
                      <vue3-select :options="DebiSel" v-model="selected" placeholder="Select" />
                    </div>
                  </div>
                  <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="mb-3">
                      <label class="form-label">Bank Details</label>
                      <vue3-select :options="AmerDe" v-model="selectedOne" placeholder="Select" />
                    </div>
                  </div>
                </div>
              </div>
...
export default {
  data() {
    return {
      ...
      selected: [],
      selectedOne: [],
      DebiSel: [{ label: "Select", value: "Select" }, { label: "Credit", value: "Credit" }, { label: "Debit", value: "Debit" }],
      AmerDe: [{ label: "Select", value: "Select" }, { label: "Bank of America", value: "Bank of America" }, { label: "U.S.Bank", value: "U.S.Bank" }],
