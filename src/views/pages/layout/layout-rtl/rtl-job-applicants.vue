  ...
  <div class="row">
            ...
            <div class="tab-pane fade" id="openings">
              <div class="d-flex align-items-center justify-content-between mb-4">
                <div class="d-flex align-items-center">
                  ...
                  <div class="me-2 overflow-hidden">
                    <p class="text-dark fw-medium text-truncate mb-0"><a href="javascript:void(0);">Senior IOS
                        Developer</a></p>
              ...
              <div class="d-flex align-items-center justify-content-between mb-4">
                <div class="d-flex align-items-center">
                  ...
                  <div class="me-2 overflow-hidden">
                    <p class="text-dark fw-medium text-truncate mb-0"><a href="javascript:void(0);">Junior PHP
                        Developer</a></p>
              ...
              <div class="d-flex align-items-center justify-content-between mb-4">
                <div class="d-flex align-items-center">
                  ...
                  <div class="me-2 overflow-hidden">
                    <p class="text-dark fw-medium text-truncate mb-0"><a href="javascript:void(0);">Junior React
                        Developer </a></p>
              ...
              <div class="d-flex align-items-center justify-content-between mb-0">
                <div class="d-flex align-items-center">
                  ...
                  <div class="me-2 overflow-hidden">
                    <p class="text-dark fw-medium text-truncate mb-0"><a href="javascript:void(0);">Senior Laravel
                        Developer</a></p>
            ...
            <div class="tab-pane fade show active" id="applicants">
              <div class="d-flex align-items-center justify-content-between mb-4">
                <div class="d-flex align-items-center">
                  ...
                  <div class="me-2 overflow-hidden">
                    <p class="text-dark fw-medium text-truncate mb-0"><a href="javascript:void(0);">Brian Villalobos</a>
                    </p>
              ...
              <div class="d-flex align-items-center justify-content-between mb-4">
                <div class="d-flex align-items-center">
                  ...
                  <div class="me-2 overflow-hidden">
                    <p class="text-dark fw-medium text-truncate mb-0"><a href="javascript:void(0);">Anthony Lewis</a>
                    </p>
              ...
              <div class="d-flex align-items-center justify-content-between mb-4">
                <div class="d-flex align-items-center">
                  ...
                  <div class="me-2 overflow-hidden">
                    <p class="text-dark fw-medium text-truncate mb-0"><a href="javascript:void(0);">Stephan Peralt</a>
                    </p>
    ...
    <div class="col-xxl-4 col-xl-6 d-flex">
      <div class="card flex-fill">
        ...
        <div class="card-body p-0 employee-table">
    ...
    <div class="col-xxl-4 col-xl-6 d-flex">
      <div class="card flex-fill">
          ...
          <div class="d-flex align-items-center">
            <div class="dropdown mb-2 ms-2">
              <a href="javascript:void(0);" class="border btn btn-white btn-md d-inline-flex align-items-center"
                ...
                <i class="ti ti-calendar ms-1 fs-14"></i>Today
              </a>
        ...
        <div class="card-body d-flex flex-column justify-content-between">
          <div class="d-flex align-items-center todo-item border bg-white p-2 br-5"
            :class="{ 'todo-strike': isClicked }" @click="toggleClicked">
          ...
          <div class="d-flex align-items-center todo-item border p-2 br-5 bg-primary-transparent"
            :class="{ 'todo-strike': isClickedOne }" @click="toggleClickedOne">
            <i class="ti ti-grid-dots ms-2"></i>
            <div class="form-check">
          ...
          <div class="d-flex align-items-center todo-item border p-2 br-5 bg-danger-transparent"
            :class="{ 'todo-strike': isClickedTwo }" @click="toggleClickedTwo">
            <i class="ti ti-grid-dots ms-2"></i>
            <div class="form-check">
          ...
          <div class="d-flex align-items-center todo-item border p-2 br-5 bg-purple-transparent"
          ...
          <div class="d-flex align-items-center todo-item border p-2 br-5 bg-info-transparent"
          ...
          <div class="d-flex align-items-center todo-item border p-2 br-5 bg-warning-transparent"
