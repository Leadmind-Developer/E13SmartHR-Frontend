              ...
              <div class="row g-3 align-items-center">
                ...
                <div class="col-md-6 col-sm-8">
                  <div class="d-flex justify-content-sm-end align-items-center flex-wrap row-gap-2">
                    <div class="me-3">
                      <vue3-select :options="WerSel" v-model="selected" placeholder="Select Language" />
                    </div>
                    <router-link to="/website-settings/add-language" class="btn btn-primary">Add Language</router-link>
                  </div>
                </div>
              </div>
            </div>
...
export default {
  data() {
    return {
      ...
      selected: [],
      WerSel: [{ label: "Spanish", value: "Spanish" }, { label: "English", value: "English" }, { label: "Spanish", value: "Spanish" }],
    };
  },
  methods: {
    toggleHeader() {
