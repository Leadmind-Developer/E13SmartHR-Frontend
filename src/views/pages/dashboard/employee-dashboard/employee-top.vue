<template>
  <div
    class="alert bg-secondary-transparent alert-dismissible fade show mb-4 d-flex align-items-center justify-content-between gap-2">
      ...
      <div class="card position-relative flex-fill">
        <div class="card-header bg-dark">
          <div class="d-flex align-items-center flex-wrap gap-2">
            <span
              class="avatar avatar-lg avatar-rounded border border-white border-2 flex-shrink-0 me-2 position-relative">
              <img src="@/assets/img/users/user-01.jpg" alt="Img">
              <span
                class="position-absolute employee-verify-badge bg-white fs-14 d-inline-flex align-items-center justify-content-center rounded-circle"><i
                  class="ti ti-discount-check-filled text-success"></i></span>
            </span>
            <div>
      ...
      <div class="card flex-fill">
        ...
        <div class="card-body">
          <div class="row align-items-center">
            ...
            <div class="col-md-12">
              <div>
                <p class="d-flex align-items-center gap-2"><span class="square-icon rounded bg-primary"><i
                      class="ti ti-check text-white fs-10 fw-bold"></i></span>Better than <span
                    class="text-gray-9">85%</span> of Employees</p>
              </div>
            </div>
          </div>
        </div>
