            ...
            <div class="row">
              ...
              <div class="col-6">
                <div class="mb-3">
                  ...
                  <vue3-select :options="Remitag" v-model="selected" placeholder="Select" />
                </div>
              </div>
              <div class="col-6">
                <div class="mb-3">
                  <label class="form-label">Priority</label>
                  <vue3-select :options="PrioSl" v-model="selectedOne" placeholder="Select" />
                </div>
              </div>
              <div class="col-lg-12">
              ...
              <div class="col-12">
                <div class="mb-3">
                  ...
                  <vue3-select :options="AddAdif" v-model="selectedTwo" placeholder="Select" />
                </div>
              </div>
              <div class="col-12">
                <div class="mb-0">
          ...
          <div class="modal-body">
            <div class="row">
              ...
              <div class="col-6">
                <div class="mb-3">
                  <label class="form-label">Tag</label>
                  <vue3-select :options="InterNal" v-model="selectedFour" placeholder="Select" />
                </div>
              </div>
              <div class="col-6">
                <div class="mb-3">
                  <label class="form-label">Priority</label>
                  <vue3-select :options="ProTodo" v-model="selectedFive" placeholder="Select" />
                </div>
              </div>
              <div class="col-lg-12">
                <div class="mb-3 summer-description-box notes-summernote">
              ...
              <div class="col-12">
                <div class="mb-3">
                  <label class="form-label">Add Assignee</label>
                  <vue3-select :options="Sophtodo" v-model="selectedSix" placeholder="Sophie" />
                </div>
              </div>
              <div class="col-12">
                <div class="mb-0">
