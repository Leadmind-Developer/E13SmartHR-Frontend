...
export default {
  data() {
    return {
      ...
      Addemployee: [{label: "Sophie", value: "Sophie"}, {label: "Cameron", value: "Cameron"}, {label: "Doris", value: "Doris"}, {label: "Rufana", value: "Rufana"}, {label: "Michael", value:"Michael"}],
      Addemp: [{label: "Select", value: "Select"}, {label: "Sophie", value: "Sophie"}, {label: "Cameron", value: "Cameron"}, {label: "Doris", value: "Doris"}],
    };
  },
  methods: {
    submitForm() {
