        ...
        <div class="card-body pb-0">
          <div class="d-flex align-items-center justify-content-between flex-wrap">
            <div class="d-flex align-items-center mb-1">
              <p class="fs-13 text-gray-9 me-3 mb-0"><i class="ti ti-square-rounded-filled me-2 text-primary"></i>Income
              </p>
              <p class="fs-13 text-gray-9 mb-0"><i class="ti ti-square-rounded-filled me-2 text-gray-2"></i>Expenses</p>
            </div>
            ...
            <table class="table table-nowrap table-borderless mb-0">
              <tbody>
                <tr>
                  <td class="px-0">
                    <div class="d-flex align-items-center">
                      <router-link to="/sales/invoice-details" class="avatar">
                        <img src="@/assets/img/users/user-39.jpg" class="img-fluid rounded-circle" alt="img">
                      </router-link>
                      <div class="me-2">
                        <h6 class="fw-medium"><router-link to="/sales/invoice-details">Redesign Website</router-link>
                        </h6>
                ...
                <tr>
                  <td class="px-0">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="me-2">
                        <h6 class="fw-medium"><router-link to="/sales/invoice-details">Module Completion</router-link>
                        </h6>
                ...
                <tr>
                  <td class="px-0">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="me-2">
                        <h6 class="fw-medium"><router-link to="/sales/invoice-details">Change on Emp
                            Module</router-link></h6>
                ...
                <tr>
                  <td class="px-0">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="me-2">
                        <h6 class="fw-medium"><router-link to="/sales/invoice-details">Changes on the
                            Board</router-link></h6>
                        <span class="fs-13 d-inline-flex align-items-center">#INVOO2<i
                            class="ti ti-circle-filled fs-4 mx-1 text-primary"></i>Ignis LLP</span>
                      </div>
                    </div>
                ...
                <tr>
                  <td class="px-0">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="me-2">
                        <h6 class="fw-medium"><router-link to="/sales/invoice-details">Hospital Management</router-link>
                        </h6>
