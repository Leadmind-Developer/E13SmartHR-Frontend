      ...
      <div class="row">
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body pb-2">
              <p>Add <code>.spinner-border-sm</code> and <code>.spinner-border.avatar-**</code> to make a smaller
        ...
        <div class="col-xl-6">
          <div class="card card-h-100">
            ...
            <div class="card-body">
              <p>Use spinners within buttons to indicate an action is currently processing or taking place. You may also
                swap the text out of the spinner element and utilize button text as needed.</p>
