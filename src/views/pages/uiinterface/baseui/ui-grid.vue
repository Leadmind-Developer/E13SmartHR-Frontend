    ...
    <div class="content">
      ...
      <div class="row">
            ...
            <div class="card-body">
              <div class="grid-showcase">
                <div class="row">
                  ...
                  <div class="col-4">
                    <span>.col-4<br />Since 9 + 4 = 13 &gt; 12, this 4-column-wide div gets
                      wrapped onto a new line as one contiguous unit.</span>
                  </div>
                  <div class="col-6">
                    <span>.col-6<br />Subsequent columns continue along the new line.</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="col-lg-6">
          <div class="card">
            <div class="card-body">
              <P>The classes can be used together with utilities to create responsive
