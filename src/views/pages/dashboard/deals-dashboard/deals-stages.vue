        ...
        <div class="card-body pb-0">
          <div>
            <div class="d-flex align-items-center">
              <h3 class="me-2">$20,245</h3>
              <span
                class="badge badge-outline-success border border-success bg-success-transparent rounded-pill me-1"><i
                  class="ti ti-arrow-up"></i>12%</span>
              <span>vs last year</span>
            </div>
            <div id="deals_stage">
              <apexchart type="bar" height="310" :options="dealsStage.stages" :series="dealsStage.series">
              </apexchart>
            </div>
          </div>
        </div>
          ...
          <div>
            <div class="border border-dashed bg-transparent-light rounded p-2 mb-2">
              <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                  <a href="javascript:void(0);" class="avatar rounded-circle border bg-white flex-shrink-0 me-2">
                    <img src="@/assets/img/company/company-24.svg" class="w-auto h-auto p-1" alt="Img">
                  </a>
                  <div>
      ...
      <div class="card flex-fill">
        ...
        <div class="card-body">
          ...
          <div>
            ...
            <div class="d-flex align-items-center justify-content-between mb-2">
              <p class="f-13 mb-0"><i class="ti ti-circle-filled text-secondary me-1"></i>Chat</p>
              <p class="f-13 fw-medium text-gray-9">$4,84,575</p>
            </div>
            <div class="d-flex align-items-center justify-content-between">
              <p class="f-13 mb-0"><i class="ti ti-circle-filled text-warning me-1"></i>Email</p>
