                ...
                <ul class="stack-submenu">
                  ...
                  <li class="submenu">
                    ...
                    <ul>
                      ...
                      <li><router-link to="/user-management/roles-permissions">Roles &
                          Permissions</router-link></li>
                    </ul>
                  </li>
                  <li class="submenu">
                  ...
                  <li class="submenu">
                    ...
                    <ul>
                      <li><router-link to="/website-settings/business-settings">Business
                  ...
                  <li class="submenu">
                    ...
                    <ul>
                      ...
                      <li><router-link to="/app-settings/approval-settings">Approval Settings</router-link>
                      </li>
                  ...
                  <li class="submenu">
                    ...
                    <ul>
                      <li><router-link to="/financial-settings/payment-gateways">Payment
                          Gateways</router-link></li>
