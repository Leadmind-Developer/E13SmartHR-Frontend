            ...
            <div class="d-flex align-items-center justify-content-between flex-wrap mb-3">
                ...
                <div class="d-flex my-xl-auto right-content align-items-center flex-wrap gap-3 mb-2">
                    <div class="avatar-list-stacked avatar-group-md">
                        ...
                        <a class="avatar bg-dark avatar-rounded fs-20 text-fixed-white" href="javascript:void(0);">
                            +
                        </a>
                    </div>
                        ...
                        <ul class="dropdown-menu  dropdown-menu-end p-3">
                            <li>
                                <router-link to="/employee/employee-list"
                                    class="dropdown-item rounded-1">Employee</router-link>
                            </li>
                            <li>
                                <router-link to="/attendance/attendance-employee"
                                    class="dropdown-item rounded-1">Attendance</router-link>
                            </li>
                            <li>
                                <router-link to="/leave/leaves-admin"
                                    class="dropdown-item rounded-1">Leave</router-link>
                            </li>
                        </ul>
                    </div>
                    <div class="head-icons mt-2">
                        <a href="javascript:void(0);" :class="{ active: isCollapsed }" @click="toggleCollapse" class=""
                    ...
                    <div class="card flex-fill mb-3">
                        <div class="card-body">
                            <div
                                ...
                                <router-link to="/reports/employee-report" class="btn btn-md btn-light">View
                                    All</router-link>
                            </div>
                            <div id="status-chart" class="mb-3">
                                <apexchart type="bar" height="45" :options="statusChart.status"
                                    :series="statusChart.series"></apexchart>
                            </div>
                            <div class="row">
                                <div class="col-4">
                    ...
                    <div class="card flex-fill">
                        <div class="card-body pb-sm-2">
                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <div id="leave-chart">
                                        <apexchart type="radialBar" width="150" height="150" :options="leaveChart.leave"
                                    ...
                                    <div class="card shadow-none mb-0 flex-fill">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center mb-3">
                                                ...
                                                <div class="ms-2">
                                                    <p class="fw-semibold text-truncate mb-0">Late Arrivals Today</p>
                                                </div>
                                            </div>
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div>
                        ...
                        <div class="card-body pb-0">
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-3">
                                <div class="d-flex align-items-center flex-wrap gap-3">
                                    ...
                                    <div class="d-flex align-items-center pe-3 border-end">
                                        <h3 class="mb-0">11<span class="ms-2 fw-normal fs-14 text-default">Late</span>
                                        </h3>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <h3 class="mb-0">6<span class="ms-2 fw-normal fs-14 text-default">Absent</span>
                                        </h3>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center gap-3">
                                    <p class="mb-0"><i
                                            class="ti ti-square-rounded-filled text-primary fs-15 me-1"></i>Present</p>
                                    <p class="mb-0"><i
                                            class="ti ti-square-rounded-filled text-secondary fs-15 me-1"></i>Late</p>
                                    <p class="mb-0"><i
                                            class="ti ti-square-rounded-filled text-warning fs-15 me-1"></i>Absent</p>
                                </div>
                            </div>
                            <div class="d-sm-flex align-items-center flex-sm-row flex-column">
                                <div id="attendance-chart" class="w-100">
                                    <apexchart type="bar" height="260" :options="attendanceChart.attendance"
                                        :series="attendanceChart.series"></apexchart>
                                </div>
                    ...
                    <div class="card flex-fill">
                        <div class="card-body pb-0">
                            <div
                                ...
                                <router-link to="/employee/employee-list" class="btn btn-md btn-light">View
                                    All</router-link>
                            </div>
                            <div id="employee-distribution">
                                <apexchart type="bar" height="340"
                                    :options="employeeDistributionChart.employeeDistribution"
                                    :series="employeeDistributionChart.series"></apexchart>
                            </div>
                        </div> <!-- end card body -->
                    </div> <!-- end card -->
                </div> <!-- end col -->
                    ...
                    <div class="card flex-fill">
                        <div class="card-body">
                            ...
                            <div
                                ...
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar flex-shrink-0">
                                        <img src="@/assets/img/users/user-26.jpg" class="rounded-circle" alt="user">
                                    </a>
                                    <div class="ms-2">
                                        <p class="fs-14 fw-medium text-truncate mb-1"><a
                                                href="javascript:void(0);">Jessica Brown</a></p>
                            ...
                            <div
                                ...
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar flex-shrink-0">
                                        <img src="@/assets/img/users/user-31.jpg" class="rounded-circle" alt="user">
                                    </a>
                                    <div class="ms-2">
                                        <p class="fs-14 fw-medium text-truncate mb-1"><a
                                                href="javascript:void(0);">Amanda Lewis</a></p>
                            ...
                            <div
                                ...
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar flex-shrink-0">
                                        <img src="@/assets/img/users/user-27.jpg" class="rounded-circle" alt="user">
                                    </a>
                                    <div class="ms-2">
                                        <p class="fs-14 fw-medium text-truncate mb-1"><a
                                                href="javascript:void(0);">James Clark</a></p>
                            ...
                            <div
                                ...
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar flex-shrink-0">
                                        <img src="@/assets/img/users/user-56.jpg" class="rounded-circle" alt="user">
                                    </a>
                                    <div class="ms-2">
                                        <p class="fs-14 fw-medium text-truncate mb-1"><a
                                                href="javascript:void(0);">Amanda Davis</a></p>
                            ...
                            <div
                                ...
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar flex-shrink-0">
                                        <img src="@/assets/img/users/user-29.jpg" class="rounded-circle" alt="user">
                                    </a>
                                    <div class="ms-2">
                                        <p class="fs-14 fw-medium text-truncate mb-1"><a href="javascript:void(0);">Lisa
                                                Anderson</a></p>
                            ...
                            <div class="row g-3">
                                <div class="col-sm-6">
                                    <div>
                                        ...
                                        <p class="mb-0"><span class="text-dark fw-medium">40%</span> - 57 Employees</p>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div>
                                        ...
                                        <p class="mb-0"><span class="text-dark fw-medium">20%</span> - 36 Employees</p>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div>
                                        ...
                                        <p class="mb-0"><span class="text-dark fw-medium">23%</span> - 64 Employees</p>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div>
                                        ...
                                        <p class="mb-0"><span class="text-dark fw-medium">17%</span> - 18 Employees</p>
                                    </div>
                                </div>
                            </div>
                        </div> <!-- end card body -->
                    ...
                    <div class="card bg-secondary shadow-none z-1 overflow-hidden">
                        <div class="card-body d-flex align-items-center justify-content-between flex-wrap gap-2">
                            ...
                            <div class="d-inline-flex align-items-center gap-2">
                                <div class="avatar-list-stacked avatar-group-md">
                                    <a href="javascript:void(0);" class="avatar avatar-rounded">
                                        <img class="border border-white" src="@/assets/img/users/user-39.jpg"
                                            alt="user">
                                    </a>
                                    <a href="javascript:void(0);" class="avatar avatar-rounded">
                                        <img class="border border-white" src="@/assets/img/users/user-41.jpg"
                                            alt="user">
                                    </a>
                                    <a href="javascript:void(0);" class="avatar avatar-rounded">
                                        <img class="border border-white" src="@/assets/img/users/user-44.jpg"
                                            alt="user">
                                    </a>
                                </div>
                                <traning-chart></traning-chart>
                            </div>
                        </div> <!-- end card body -->
                ...
                <div class="col-xxl-4 col-xl-12 d-flex">
                    <div class="card flex-fill">
                        <div class="card-body d-flex justify-content-between flex-column">
                            <div>
                                ...
                                <div class="p-3 rounded border border-start border-start-4 border-start-primary mb-3">
                                    <div class="d-flex align-items-center justify-content-between gap-2 flex-wrap mb-3">
                                        ...
                                        <div class="avatar-list-stacked avatar-group-md">
                                            <a href="javascript:void(0);" class="avatar avatar-rounded">
                                                <img class="border border-white" src="@/assets/img/users/user-31.jpg"
                                                    alt="user">
                                            </a>
                                            <a href="javascript:void(0);" class="avatar avatar-rounded">
                                                <img class="border border-white" src="@/assets/img/users/user-32.jpg"
                                                    alt="user">
                                            </a>
                                            <a href="javascript:void(0);" class="avatar avatar-rounded">
                                                <img class="border border-white" src="@/assets/img/users/user-29.jpg"
                                                    alt="user">
                                            </a>
                                            <a href="javascript:void(0);" class="avatar avatar-rounded">
                                                <img class="border border-white" src="@/assets/img/users/user-56.jpg"
                                                    alt="user">
                                            </a>
                                ...
                                <div class="p-3 rounded border border-start border-start-4 border-start-secondary mb-3">
                                    <div class="d-flex align-items-center justify-content-between gap-2 flex-wrap mb-3">
                                        <div>
                            ...
                            <router-link to="/recuritment/candidates-grid" class="btn btn-light w-100">View
                                All<i class="ti ti-arrow-right ms-1"></i></router-link>
                        </div> <!-- end card body -->
                    </div> <!-- end card -->
                </div> <!-- end col -->
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div>
                                            <div id="deduction-chart">
                                                <apexchart width="100" height="70" type="bar"
                                                    :options="deductionChart.deduction" :series="deductionChart.series">
                                                </apexchart>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div>
                                            ...
                                            <p class="mb-0"><span class="text-success">
                                                    <i class="ti ti-arrow-wave-right-up me-1"></i>+55%</span> Increased
                                            </p>
                                        </div>
                                        <div class="text-end">
                                            ...
                                            <div id="payroll-chart">
                                                <apexchart width="100" height="40" type="bar"
                                                    :options="payrollChart.payroll" :series="payrollChart.series">
                                                </apexchart>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="card flex-fill">
                        <div class="card-body">
                            <div
                                ...
                                <router-link to="/leave/leaves-employee" class="btn btn-md btn-light">View
                                    All</router-link>
                            </div>
                            <div
                                ...
                                <div>
                                    <div class="d-flex align-items-center mb-1">
                                        ...
                                        <div class="ms-2">
                                            <p class="fs-14 fw-semibold text-truncate mb-0"><a
                                                    href="javascript:void(0);">Hendrita
                                                    Merkel</a></p>
                                        </div>
                                    </div>
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-sm btn-outline-primary">Decline</a>
                                </div>
                            </div>
                            <div
                                class="p-2 rounded border d-flex align-items-sm-center justify-content-between gap-2 flex-column flex-sm-row  mb-2">
                                <div>
                                    <div class="d-flex align-items-center mb-1">
                                        ...
                                        <div class="ms-2">
                                            <p class="fs-14 fw-semibold text-truncate mb-0"><a
                                                    href="javascript:void(0);">Michael
                                                    Brown</a></p>
                                        </div>
                                    </div>
                                    <div class="d-inline-flex align-items-center gap-1">
                            ...
                            <div
                                ...
                                <div>
                                    <div class="d-flex align-items-center mb-1">
                                        <a href="javascript:void(0);" class="avatar avatar-sm flex-shrink-0">
                                            <img src="@/assets/img/users/user-30.jpg" class="rounded-circle" alt="user">
                                        </a>
                                        <div class="ms-2">
                                            <p class="fs-14 fw-semibold text-truncate mb-0"><a
                                                    href="javascript:void(0);">Daniel
                                                    Martinez</a></p>
                                        </div>
                                    </div>
                                    <div class="d-inline-flex align-items-center gap-1">
...
import {
    leaveChart, statusChart, attendanceChart,
    employeeDistributionChart, deductionChart, payrollChart
} from "./data";
import TraningChart from "./traning-chart.vue";
export default {
    components: {
        TraningChart,
    },
