<template>
  ...
  <div class="page-wrapper">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-md-6" v-for="(result, index) in searchResults" :key="index">
              <div class="card shadow-none">
                <div class="card-body">
                  <a :href="result.url" class="text-info text-truncate mb-2">{{ result.url }}</a>
                  ...
                  <div class="d-flex align-items-center flex-wrap row-gap-2">
                    ...
                    <div class="text-gray-9 d-flex align-items-center me-3 pe-3 border-end">
                      <i v-for="n in result.stars" :key="'star-filled-' + n" class="ti ti-star-filled text-warning me-1"></i>
                      <i v-for="n in 5 - result.stars" :key="'star-empty-' + n" class="ti ti-star-filled text-gray-2 me-1"></i>
                      ({{ result.reviews }})
                    </div>
          ...
          <div class="row g-3">
            ...
            <!-- Vue Easy Lightbox -->
            <vue-easy-lightbox v-model:visible="visible" :imgs="imageUrls" :index="lightboxIndex" @hide="closeLightbox" />
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="footer d-sm-flex align-items-center justify-content-between border-top bg-white p-3">
      ...
      <p>
        Designed &amp; Developed By <a href="javascript:void(0);" class="text-primary">Dreams</a>
      </p>
    </div>
  </div>
  <!-- /Page Wrapper -->
    ...
    const searchResults = [
      {
        ...
        description: "SmartHR - Html, Vue 3, Angular 17+ & Node HR Project Management & CRM Admin Dashboard Template",
        sales: "1.7K",
        stars: 4,
        reviews: 45,
        price: "$35",
      },
      {
        ...
        description: "SmartHR - React 18+ & Html HRMS, Payroll, CRM and HR Project Management Admin Dashboard Template",
        sales: 513,
        stars: 4,
        reviews: 18,
        price: "$35",
      },
      {
        ...
        description: "SmartHR - Laravel 10 + Html HRMS, Payroll, CRM and HR Project Management Admin Dashboard Template",
        sales: 339,
        stars: 4,
        reviews: 8,
        price: "$35",
      },
      {
        ...
        description: "SmartHR - HRMS, Payroll, and HR Project Management Mobile Template (Framework7 + Bootstrap + PWA)",
        sales: 293,
        stars: 4,
        reviews: 5,
        price: "$24",
