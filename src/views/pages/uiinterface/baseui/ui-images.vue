              ...
              <div class="row">
                <div class="col-xl-12">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-3">
                      <img src="@/assets/img/profiles/avatar-03.jpg" alt="image" class="img-fluid rounded-circle"
                        width="133" />
                      <p class="mb-0">
                    ...
                    <div class="col-sm-3">
                      <img src="@/assets/img/profiles/avatar-02.jpg" alt="image" class="img-thumbnail rounded-pill"
                        width="133" />
                      <p class="mb-0">
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body d-flex justify-content-between gap-2">
              <figure class="figure">
                <img class="bd-placeholder-img figure-img img-fluid rounded card-img" src="@/assets/img/img-1.jpg"
                  alt="..." />
