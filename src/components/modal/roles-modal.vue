            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="mb-3">
                  ...
                  <vue3-select :options="RoleStatu" v-model="selected" placeholder="Select" />
                </div>
              </div>
            </div>
          </div>
...
export default {
  data() {
    return {
      selected: [],
      selectedOne: [],
      RoleStatu: [{label: "Select", value: "Select"}, {label: "Active", value: "Active"}, {label: "Inactive", value: "Inactive"}],
      EditRoleStatu: [{label: "Select", value: "Select"}, {label: "Active", value: "Active"}, {label: "Inactive", value: "Inactive"}],
    };
  },
  methods: {
    submitForm() {
