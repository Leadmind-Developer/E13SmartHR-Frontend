            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <vue3-select :options="Planname" v-model="selected1" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
                  <label class="form-label">Plan Type <span class="text-danger"> *</span></label>
                  <vue3-select :options="Plantype" v-model="selected2" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-4">
                <div class="mb-3">
                  <label class="form-label">Currency <span class="text-danger"> *</span></label>
                  <vue3-select :options="Currency" v-model="selected3" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-4">
                <div class="mb-3">
                  <label class="form-label">Language <span class="text-danger"> *</span></label>
                  <vue3-select :options="Language" v-model="selected4" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-4">
                <div class="mb-3">
                  <label class="form-label">Status</label>
                  <vue3-select :options="Status" v-model="selected5" placeholder="Select" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="modal-body pb-0">
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  <label class="form-label">Plan Name <span class="text-danger"> *</span></label>
                  <vue3-select :options="Planname" v-model="selected6" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
                  <label class="form-label">Plan Type <span class="text-danger"> *</span></label>
                  <vue3-select :options="Plantype" v-model="selected7" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-4">
                <div class="mb-3">
                  <label class="form-label">Currency <span class="text-danger"> *</span></label>
                  <vue3-select :options="Currency" v-model="selected8" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-4">
                <div class="mb-3">
                  <label class="form-label">Language <span class="text-danger"> *</span></label>
                  <vue3-select :options="Language" v-model="selected9" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-4">
                <div class="mb-3">
                  <label class="form-label">Status</label>
                  <vue3-select :options="Status" v-model="selected10" placeholder="Select" />
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <vue3-select :options="Statusone" v-model="selected11" placeholder="Busy" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="mb-3">
                      ...
                      <vue3-select :options="Choosedeal" v-model="selected12" placeholder="Select" />
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <vue3-select :options="Documenttype" v-model="selected13" placeholder="Select" />
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="mb-3">
                      <label class="form-label">Owner <span class="text-danger"> *</span></label>
                      <vue3-select :options="Owner" v-model="selected14" placeholder="Select" />
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="mb-3">
                  ...
                  <div class="col-md-6">
                    <div class="input-block mb-3">
                      ...
                      <vue3-select :options="Locale" v-model="selected15" placeholder="Select" />
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="mb-3">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="mb-3">
                  ...
                  <vue3-select :options="Accounttype" v-model="selected16" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-12">
                <div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="mb-3">
                  ...
                  <vue3-select :options="Dealname" v-model="selected17" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="input-block mb-3">
                  ...
                  <vue3-select :options="Pipeline" v-model="selected18" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
                  <label class="form-label">Status <span class="text-danger"> *</span></label>
                  <vue3-select :options="Lost" v-model="selected19" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-4">
                <div class="mb-3">
                  <label class="form-label">Deal Value <span class="text-danger"> *</span></label>
                  <vue3-select :options="Dealvalue" v-model="selected20" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-4">
                <div class="mb-3">
                  <label class="form-label">Currency<span class="text-danger"> *</span></label>
                  <vue3-select :options="Currencyvalue" v-model="selected21" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-4">
                <div class="mb-3">
              ...
              <div class="col-md-12">
                <div class="mb-3">
                  ...
                  <vue3-select :options="Contact" v-model="selected22" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-12">
                <div class="mb-3">
                  <label class="form-label">Project * <span class="text-danger"> *</span></label>
                  <vue3-select :options="Project" v-model="selected23" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
              ...
              <div class="col-md-12">
                <div class="mb-3">
                  ...
                  <vue3-select :options="Assignee" v-model="selected24" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
                  <label class="form-label">Tags <span class="text-danger"> *</span></label>
                  <vue3-select :options="Tags" v-model="selected25" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <vue3-select :options="Source" v-model="selected26" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
                  <label class="form-label">Priority <span class="text-danger"> *</span></label>
                  <vue3-select :options="Priority" v-model="selected27" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-12">
                <div class="mb-3">
