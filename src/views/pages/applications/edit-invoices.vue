                  ...
                  <div class="col-md-4 col-sm-12">
                    <div class="mb-3">
                      ...
                      <div class="input-icon position-relative w-100 me-2">
                        ...
                        <a-date-picker v-model="valuTwo" class="form-control datetimepicker" placeholder="dd/mm/yyyy" />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="mb-3">
                      ...
                      <vue3-select :options="EditDebiSel" v-model="selected" placeholder="Credit" />
                    </div>
                  </div>
                  <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="mb-3">
                      <label class="form-label">Bank Details</label>
                      <vue3-select :options="EditAmerDe" v-model="selectedOne" placeholder="Bank of America" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="d-flex justify-content-center align-items-center">
              <div class="flex-fill">
                <div class="row justify-content-between align-items-center border-bottom mb-3">
                  <div class="col-md-6">
                    <div class="mb-2 invoice-logo">
                      ...
                      <img src="@/assets/img/logo-white.png" class="img-fluid logo-white d-none" alt="logo">
                    </div>
                ...
                <div class="row justify-content-end align-items-end text-end">
                  <div class="col-md-3">
                    <div class="text-end signature-img">
...
export default {
  data() {
    return {
      ...
      selected: [],
      selectedOne: [],
      EditDebiSel: [{ label: "Select", value: "Select" }, { label: "Credit", value: "Credit" }, { label: "Debit", value: "Debit" }],
      EditAmerDe: [{ label: "Select", value: "Select" }, { label: "Bank of America", value: "Bank of America" }, { label: "U.S.Bank", value: "U.S.Bank" }],
