            ...
            <div class="card-body p-0">
              <div class="border-bottom p-3">
                <div class="mb-3">
                  ...
                  <vue3-select :options="MediumTick" v-model="selected" placeholder="High" />
                </div>
                <div class="mb-3">
                  <label class="form-label">Assign To</label>
                  <vue3-select :options="HerMan" v-model="selectedOne" placeholder="Edgar Hansel" />
                </div>
                <div>
                  <label class="form-label">Ticket Status</label>
                  <vue3-select :options="HoldTick" v-model="selectedTwo" placeholder="Open" />
                </div>
              </div>
...
export default {
  data() {
    return {
      ...
      selectedTwo: [],
      selectedThree: [],
      MediumTick: [{label: "High", value: "High"}, {label: "Medium", value: "Medium"}, {label: "Low", value: "Low"}],
      HerMan: [{label: "Edgar Hansel", value: "Edgar Hansel"}, {label: "Juan Hermann", value: "Juan Hermann"}],
      HoldTick: [{label: "Select", value: "Select"}, {label: "Open", value: "Open"}, {label: "On Hold", value: "On Hold"}, {label: "Reopened", value: "Reopened"}],
