          ...
          <div class="card">
            <div class="card-body pb-1">
              <div class="d-flex align-items-center mb-3">
                ...
                <a href="javascript:void(0);" class="text-dark fs-16 fw-medium text-truncate">Introduction to HRMS <span
                ...
                <div class="card mb-3">
                  <div class="card-body">
                    <div class="d-flex align-items-center mb-2 pb-1">
                      ...
                      <a href="javascript:void(0);" class="text-dark fs-14 fw-medium text-truncate">What is an HRMS and
                        Why is it Important?
                      </a>
                    </div>
                    <div class="ps-3">
              ...
              <div class="col-xl-12">
                <div class="card mb-3">
                  <div class="card-body">
                    <div class="d-flex align-items-center mb-2 pb-1">
                      <i class="ti ti-file me-1"></i>
                      <a href="javascript:void(0);" class="text-dark fs-14 fw-medium text-truncate">How HRMS Helps
                        Automate HR Tasks
                      </a>
                    </div>
                    <div class="ps-3">
              ...
              <div class="col-xl-12">
                <div class="card mb-3">
                  <div class="card-body">
                    <div class="d-flex align-items-center mb-2 pb-1">
                      <i class="ti ti-file me-1"></i>
                      <a href="javascript:void(0);" class="text-dark fs-14 fw-medium text-truncate">HRMS Terminology : A
                        Beginner’s Guide</a>
                    </div>
                    <div class="ps-3">
                      <p class="fs-14 fw-normal mb-1">
        ...
        <div class="col-xl-4 theiaStickySidebar">
          ...
          <div class="card">
            <div class="card-body pb-1">
              ...
              <div class="d-flex align-items-center mb-2 pb-1">
                <i class="ti ti-file me-1"></i>
                <a href="javascript:void(0);" class="text-gray fs-14 fw-normal text-truncate">What is an HRMS and Why is
                  it Important?
                </a>
              </div>
              <div class="d-flex align-items-center mb-2 pb-1">
