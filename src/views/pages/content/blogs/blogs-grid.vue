          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="border-bottom mb-3">
                <h5 class="mb-3">
                  <router-link to="/blog/blog-categories" class="fs-16 fw-medium text-truncate">The Evolution of HRMS:
        ...
        <div class="col-xxl-4 col-md-6">
          <div class="card">
            <div class="card-body">
              ...
              <div class="border-bottom mb-3">
                <h5 class="mb-3">
                  <router-link to="/blog/blog-categories" class="fs-16 fw-medium text-truncate">HRMS Implementation:
              ...
              <div class="border-bottom mb-3">
                <h5 class="mb-3">
                  <router-link to="/blog/blog-categories" class="fs-16 fw-medium text-truncate">Scaling Your HR
                    Operations with HRMS</router-link>
                </h5>
              </div>
              <div class="d-flex align-items-center justify-content-between text-center">
                <div class="me-3">
        ...
        <div class="col-xxl-4 col-md-6">
          <div class="card">
            <div class="card-body">
              ...
              <div class="border-bottom mb-3">
                <h5 class="mb-3">
                  <router-link to="/blog/blog-categories" class="fs-16 fw-medium text-truncate">How HRMS Drives
