      ...
      <Carousel :wrap-around="true" :settings="settings" :breakpoints="breakpoints">
        <Slide v-for="item in DemoDw" :key="item.id">
          <div class="video-wrap">
            <video width="100" height="100" class="js-player" crossorigin playsinline :poster="getImageUrl(item.Image)">
            ...
            <div class="d-flex align-items-center justify-content-between video-content">
              ...
              <div class="d-flex align-items-center justify-content-between video-content">
                <h6 class="fw-medium"><a href="#" data-bs-toggle="offcanvas" data-bs-target="#preview">Inertia Movie</a>
                </h6>
