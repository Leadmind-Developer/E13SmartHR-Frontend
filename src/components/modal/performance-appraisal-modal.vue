...
export default {
  data() {
    return {
      ...
      selectedTwo: [],
      selectedThree: [],
      Employee: [{ label: "Select", value: "Select" }, { label: "Anthony Lewis", value: "Anthony Lewis" }, { label: "Brian Villalobos", value: "Brian Villalobos" }, { label: "Harvey Smith", value: "Harvey Smith" }],
      Status: [{ label: "Select", value: "Select" }, { label: "Active", value: "Active" }, { label: "Inactive", value: "Inactive" }],
      valueOne,
      valueTwo,
    };
  },
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <vue3-select :options="Employee" v-model="selected" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
          ...
          <div class="modal-body pb-0">
            <div class="row">
              <div class="col-md-6">
                <div class="mb-3">
                  <label class="form-label">Employee</label>
                  <vue3-select :options="Employee" v-model="selectedTwo" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
