...
export default {
  data() {
    return {
      ...
      selectedTwelve: [],
      selectedThirteen: [],
      PlanName: [{label:"Select", value: "Select"}, {label: "Advanced", value: "Advanced"}, {label: "Basic", value: "Basic"}, {label: "Enterprise", value: "Enterprise"}],
      PlanType: [{label:"Select", value: "Select"}, {label: "Monthly", value: "Monthly"}, {label: "Yearly", value: "Yearly"}],
      PlanPosition: [{label:"Select", value: "Select"}, {label: "1", value: "1"}, {label: "2", value: "2"}, {label: "3", value: "3"}],
      PlanCurrency: [{label:"Select", value: "Select"}, {label: "USD", value: "USD"}, {label: "EURO", value: "EURO"}],
      PlanFree: [{label:"Select", value: "Select"}, {label: "Fixed", value: "Fixed"}, {label: "Percentage", value: "Percentage"}],
      DiscountType: [{label:"Select", value: "Select"}, {label: "Fixed", value: "Fixed"}, {label: "Percentage", value: "Percentage"}],
      PackStatus: [{label:"Select", value: "Select"}, "Active", "Inactive"],
    };
  },
  methods: {
    submitForm() {
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  >
                  <vue3-select :options="PlanType" v-model="selectedOne" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <vue3-select :options="PlanFree" v-model="selectedFour" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-3">
                <div class="mb-3">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <vue3-select :options="PlanFree" v-model="selectedEleven" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-3">
                <div class="mb-3">
