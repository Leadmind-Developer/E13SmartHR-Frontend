        ...
        <div class="col-xl-9 budget-role-notes" :class="{ 'budgeted-role-notes': isBudgetedRoleNotes }">
          <div class="bg-white rounded-3 d-flex align-items-center justify-content-between flex-wrap mb-4 p-3 pb-0">
            <div class="d-flex align-items-center mb-3">
              <div class="me-3">
                <vue3-select :options="Bulk" v-model="selected" placeholder="Bulk Actions" />
              </div>
                      ...
                      <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div>
                          ...
                          <div class="dropdown-menu notes-menu dropdown-menu-end">
                            ...
                            <a href="#" class="dropdown-item" data-bs-toggle="modal"
                              data-bs-target="#delete_modal"><span><i data-feather="trash-2"></i></span>Delete</a>
                    ...
                    <div class="card-body p-4">
                      <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div>
                          ...
                          <div class="dropdown-menu notes-menu dropdown-menu-end">
                            <a href="#" class="dropdown-item" data-bs-toggle="modal"
                              data-bs-target="#edit-note-units"><span><i class="ti ti-edit"></i></span>Edit</a>
                            <a href="#" class="dropdown-item" data-bs-toggle="modal"
                              data-bs-target="#delete_modal"><span><i class="ti ti-trash"></i></span>Delete</a>
                            <a href="javascript:void(0);" class="dropdown-item"><span><i
                                  class="ti ti-star"></i></span>Not
                              Important</a>
                            <a href="#" class="dropdown-item" data-bs-toggle="modal"
                              data-bs-target="#view-note-units"><span><i class="ti ti-eye"></i></span>View</a>
                          </div>
                        </div>
                      </div>
                      <div class="my-3">
...
export default {
  data() {
    return {
      ...
      Bulk: [{ label: "Bulk Actions", value: "Bulk Actions" }, { label: "Delete Marked", value: "Delete Marked" }, { label: "Unmark All", value: "Unmark All" }, { label: "Mark All", value: "Mark All" }],
      Last: [{ label: "Recent", value: "Recent" }, { label: "Last Modified", value: "Last Modified" }, { label: "Last Modified by me", value: "Last Modified by me" }],
    };
  },
  methods: {
    toggleCollapse() {
