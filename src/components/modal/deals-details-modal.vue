            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  >
                  <vue3-select :options="Enterpro" v-model="selected" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  >
                  <vue3-select :options="YearkyMin" v-model="selectedOne" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-4">
                <div class="mb-3">
                  ...
                  >
                  <vue3-select :options="CurrUds" v-model="selectedTwo" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-4">
                <div class="mb-3">
                  ...
                  >
                  <vue3-select :options="ChineEng" v-model="selectedThree" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-4">
                <div class="mb-3">
                  <label class="form-label">Status</label>
                  <vue3-select :options="ActDeta" v-model="selectedFour" placeholder="Select" />
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  >
                  <vue3-select :options="Noans" v-model="selectedTen" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="mb-3">
                      ...
                      >
                      <vue3-select :options="ChoDeal" v-model="selectedEleven" placeholder="Collins" />
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="mb-3">
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      >
                      <vue3-select :options="JackSoD" v-model="selectedThirteen" placeholder="Select" />
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="mb-3">
                  ...
                  <div class="col-md-6">
                    <div class="input-block mb-3">
                      ...
                      >
                      <vue3-select :options="EngSel" v-model="selectedFourteen" placeholder="Select" />
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="mb-3">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="mb-3">
                  ...
                  >
                  <vue3-select :options="Gamil" v-model="selectedFifteen" placeholder="Select" />
                </div>
              </div>
              <div class="col-md-12">
                <div>
...
export default {
  data() {
    return {
      ...
      selectedFourteen: [],
      selectedFifteen: [],
      Gamil: [{label: "Select", value: "Select"}, {label: "Gamil", value: "Gamil"}, {label: "Outlook", value: "Outlook"}, {label: "Imap", value: "Imap"}],
      EngSel: [{label: "Select", value: "Select"}, {label: "en", value: "en"}, {label: "es", value: "es"}, {label:"ru", value: "ru"}],
      JackSoD: [{label: "Select", value: "Select"}, {label: "Admin", value: "Admin"}, {label: "Jackson Daniel", value: "Jackson Daniel"}],
      ProposalCon: [{label: "Select", value: "Select"}, {label: "Contract", value: "Contract"}, {label: "Proposal", value: "Proposal"}, {label: "Quote", value: "Quote"}],
      ChoDeal: [{label: "Select", value: "Select"}, {label: "Collins", value: "Collins"}, {label: "Wisozk", value: "Wisozk"}, {label: "Wlater", value: "Wlater"}],
      Noans: [{label: "Busy", value: "Busy"}, {label: "Unavailable", value: "Unavailable"}, {label: "No Answer", value: "No Answer"}, {label: "Wrong Answer", value: "Wrong Answer"}],
      ActDeta: [{label: "Select", value: "Select"}, {label: "Active", value: "Active"}, {label: "Inactive",value: "Inactive"}],
      ChineEng: [{label: "Select", value: "Select"}, {label: "English", value: "English"}, {label: "Chinese", value: "Chinese"}],
      CurrUds: [{label: "Select", value: "Select"}, {label: "USD", value: "USD"}, {label: "Euro", value: "Euro"}],
      YearkyMin: [{label: "Select", value: "Select"}, {label: "Monthly", value: "Monthly"}, {label: "Yearly", value: "Yearly"}],
      Enterpro: [{label: "Select", value: "Select"}, {label: "Advanced", value: "Advanced"}, {label: "Basic", value: "Basic"}, {label: "Enterprise", value: "Enterprise"}],
      EditActDeta: [{label: "Select", value: "Select"}, {label: "Active", value: "Active"}, {label: "Inactive",value: "Inactive"}],
      EditChineEng: [{label: "Select", value: "Select"}, {label: "English", value: "English"}, {label: "Chinese", value: "Chinese"}],
      EditCurrUds: [{label: "Select", value: "Select"}, {label: "USD", value: "USD"}, {label: "Euro", value: "Euro"}],
      EditYearkyMin: [{label: "Select", value: "Select"}, {label: "Monthly", value: "Monthly"}, {label: "Yearly", value: "Yearly"}],
      EditEnterpro: [{label: "Select", value: "Select"}, {label: "Advanced", value: "Advanced"}, {label: "Basic", value: "Basic"}, {label: "Enterprise", value: "Enterprise"}],
    };
  },
  computed: {
    buttonLabel() {
